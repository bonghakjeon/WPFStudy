...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Day.Horizontal.SalesByDayHorizontalByCategoryBotPack
...
{
  public class SalesByDayHorizontalByCategoryBotPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private SalesByDayHorizontalByCategoryBotDic _DataBody;
    ...
    public SalesByDayHorizontalByCategoryBotDic DataBody
    {
      get => this._DataBody;
      set
      {

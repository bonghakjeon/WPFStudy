...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Date.SaleByDayDateCategoryBotBefore
...
{
  public class SaleByDayDateCategoryBotBefore : 
    SaleByDayDateCategoryMidBefore<SaleByDayDateCategoryBotBefore>
  {
    ...
    protected override UbModelBase CreateClone => (UbModelBase) new SaleByDayDateCategoryBotBefore();

    public override object Clone()
    {
      SaleByDayDateCategoryBotBefore categoryBotBefore = base.Clone() as SaleByDayDateCategoryBotBefore;
    ...
    public void PutData(SaleByDayDateCategoryBotBefore pSource)
    {
      this.PutData((SaleByDayDateCategoryMidBefore) pSource);
      this.ctg_ViewCode = pSource.ctg_ViewCode;
      this.ctg_CategoryName = pSource.ctg_CategoryName;
    }

    public bool IsZero(EnumZeroCheck pCheckType, SaleByDayDateCategoryBotBefore pSource) => pSource == null || this.IsZero(pCheckType, (SaleByDayDateCategoryMidBefore) pSource);
    ...
    public async Task<IList<SaleByDayDateCategoryBotBefore>> SelectDateCategoryBotBeforeListAsync(
      object p_param)
    {
      SaleByDayDateCategoryBotBefore categoryBotBefore1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(categoryBotBefore1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<SaleByDayDateCategoryBotBefore>) null;
        }
        IList<SaleByDayDateCategoryBotBefore> lt_list = (IList<SaleByDayDateCategoryBotBefore>) new List<SaleByDayDateCategoryBotBefore>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            SaleByDayDateCategoryBotBefore categoryBotBefore2 = categoryBotBefore1.OleDB.Create<SaleByDayDateCategoryBotBefore>();
    ...
    public async IAsyncEnumerable<SaleByDayDateCategoryBotBefore> SelectDateCategoryBotBeforeEnumerableAsync(
      object p_param)
    {
      SaleByDayDateCategoryBotBefore categoryBotBefore1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

...
// Type: UniBiz.Bo.Models.UniStock.Statement.Day.Vertical.StatementDayVerticalByCategoryMidPack
...
{
  public class StatementDayVerticalByCategoryMidPack : BindableBase
  {
    private IList<CategoryView> _DataHeader;
    private StatementDayVerticalByCategoryMidDic _DataBody;
    ...
    public StatementDayVerticalByCategoryMidDic DataBody
    {
      get => this._DataBody;
      set
      {

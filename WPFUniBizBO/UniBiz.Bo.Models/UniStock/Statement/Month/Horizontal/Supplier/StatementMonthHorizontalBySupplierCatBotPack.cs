...
// Type: UniBiz.Bo.Models.UniStock.Statement.Month.Horizontal.Supplier.StatementMonthHorizontalBySupplierCatBotPack
...
{
  public class StatementMonthHorizontalBySupplierCatBotPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private StatementMonthHorizontalBySupplierCatBotDic _DataBody;
    ...
    public StatementMonthHorizontalBySupplierCatBotDic DataBody
    {
      get => this._DataBody;
      set
      {

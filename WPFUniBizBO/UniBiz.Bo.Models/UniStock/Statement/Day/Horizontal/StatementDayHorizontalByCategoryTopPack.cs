...
// Type: UniBiz.Bo.Models.UniStock.Statement.Day.Horizontal.StatementDayHorizontalByCategoryTopPack
...
{
  public class StatementDayHorizontalByCategoryTopPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private StatementDayHorizontalByCategoryTopDic _DataBody;
    ...
    public StatementDayHorizontalByCategoryTopDic DataBody
    {
      get => this._DataBody;
      set
      {

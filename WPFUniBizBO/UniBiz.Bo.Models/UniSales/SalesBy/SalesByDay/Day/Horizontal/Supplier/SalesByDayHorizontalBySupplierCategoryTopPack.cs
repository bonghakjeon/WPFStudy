...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Day.Horizontal.Supplier.SalesByDayHorizontalBySupplierCategoryTopPack
...
{
  public class SalesByDayHorizontalBySupplierCategoryTopPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private SalesByDayHorizontalBySupplierCategoryTopDic _DataBody;
    ...
    public SalesByDayHorizontalBySupplierCategoryTopDic DataBody
    {
      get => this._DataBody;
      set
      {

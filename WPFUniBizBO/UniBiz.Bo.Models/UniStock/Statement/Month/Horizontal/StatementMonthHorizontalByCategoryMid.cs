...
// Type: UniBiz.Bo.Models.UniStock.Statement.Month.Horizontal.StatementMonthHorizontalByCategoryMid
...
{
  public class StatementMonthHorizontalByCategoryMid : 
    StatementMonthHorizontalByCategoryTop<StatementMonthHorizontalByCategoryMid>
  {
    ...
    public override string ToString() => string.Format("{0} [{1}:{2}>{3}] Count : {4}", (object) nameof (StatementMonthHorizontalByCategoryMid), (object) this.si_StoreName, (object) this.ctg_lv1_Name, (object) this.ctg_lv2_Name, (object) this.Lt_Details.Count);
    ...
    public void PutInfo(StatementMonthHorizontalByCategoryMid pSource)
    {
      this.PutInfo((StatementMonthHorizontalByCategoryTop) pSource);
    ...
    public void Add(StatementMonthHorizontalByCategoryMid item)
    {
    ...
    public void AddRange(IList<StatementMonthHorizontalByCategoryMid> infos)
    {
      foreach (StatementMonthHorizontalByCategoryMid info in (IEnumerable<StatementMonthHorizontalByCategoryMid>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, StatementMonthHorizontalByCategoryMid pSource) => pSource == null || this.IsZero(pCheckType, (StatementMonthHorizontalByCategoryTop) pSource);
    ...
    public async Task<IList<StatementMonthHorizontalByCategoryMid>> SelectMonthHorizontalByCategoryMidListAsync(
      object p_param)
    {
      StatementMonthHorizontalByCategoryMid horizontalByCategoryMid1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(horizontalByCategoryMid1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<StatementMonthHorizontalByCategoryMid>) null;
        }
        IList<StatementMonthHorizontalByCategoryMid> lt_list = (IList<StatementMonthHorizontalByCategoryMid>) new List<StatementMonthHorizontalByCategoryMid>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            StatementMonthHorizontalByCategoryMid horizontalByCategoryMid2 = horizontalByCategoryMid1.OleDB.Create<StatementMonthHorizontalByCategoryMid>();
    ...
    public async IAsyncEnumerable<StatementMonthHorizontalByCategoryMid> SelectMonthHorizontalByCategoryMidEnumerableAsync(
      object p_param)
    {
      StatementMonthHorizontalByCategoryMid horizontalByCategoryMid1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

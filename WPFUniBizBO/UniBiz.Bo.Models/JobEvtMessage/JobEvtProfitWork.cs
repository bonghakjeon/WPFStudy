...
// Type: UniBiz.Bo.Models.JobEvtMessage.JobEvtProfitWork
...
{
  public class JobEvtProfitWork : JobEvtBase
  {
    private int _si_StoreCode;
    private string _si_StoreCodeIn;
    private ProfitLossWorkCntTPack _WorkInfo;
    ...
    public ProfitLossWorkCntTPack WorkInfo
    {
      get => this._WorkInfo;
      set
      {
    ...
    public JobEvtProfitWork() => this.resource = 9;
  }
}

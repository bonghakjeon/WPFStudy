...
// Type: UniBiz.Bo.Models.UniStock.Statement.Month.Horizontal.StatementMonthHorizontalByDept
...
{
  public class StatementMonthHorizontalByDept : 
    StatementMonthHorizontalByTeam<StatementMonthHorizontalByDept>
  {
    private int _dpt_ID;
    private string _dpt_ViewCode;
    private string _dpt_DeptName;

    public override string KeyCode => string.Format("{0}|{1}|{2}|{3}", (object) this.sh_StoreCode, (object) this.dpt_lv1_ID, (object) this.dpt_lv2_ID, (object) this.dpt_ID);
    ...
    public override string ToString() => string.Format("{0} [{1}:{2}>{3}>{4}] Count : {5}", (object) nameof (StatementMonthHorizontalByDept), (object) this.si_StoreName, (object) this.dpt_lv1_Name, (object) this.dpt_lv2_Name, (object) this.dpt_lv3_Name, (object) this.Lt_Details.Count);
    ...
    public void PutInfo(StatementMonthHorizontalByDept pSource)
    {
      this.PutInfo((StatementMonthHorizontalByTeam) pSource);
    ...
    public void InitInfo(StatementMonthHorizontalByDept pData, IList<DateTime> p_Days)
    {
      if (!this.KeyCode.Equals(pData.KeyCode))
        throw new Exception("pData 의 [sh_StoreCode|dpt_lv1_ID|dpt_lv2_ID|dpt_ID] 이 KeyCode 와 다릅니다");
      this.PutInfo(pData);
    ...
    public void Add(StatementMonthHorizontalByDept item)
    {
      ...
      else
      {
        ...
        if (!this.KeyCode.Equals(item.KeyCode))
          throw new Exception("item 의 [sh_StoreCode|dpt_lv1_ID|dpt_lv2_ID|dpt_ID] 이 KeyCode 와 다릅니다");
      }
    ...
    public void AddRange(IList<StatementMonthHorizontalByDept> infos)
    {
      foreach (StatementMonthHorizontalByDept info in (IEnumerable<StatementMonthHorizontalByDept>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, StatementMonthHorizontalByDept pSource) => pSource == null || this.IsZero(pCheckType, (StatementMonthHorizontalByTeam) pSource);
    ...
    public async Task<IList<StatementMonthHorizontalByDept>> SelectMonthHorizontalByDeptListAsync(
      object p_param)
    {
      StatementMonthHorizontalByDept horizontalByDept1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(horizontalByDept1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<StatementMonthHorizontalByDept>) null;
        }
        IList<StatementMonthHorizontalByDept> lt_list = (IList<StatementMonthHorizontalByDept>) new List<StatementMonthHorizontalByDept>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            StatementMonthHorizontalByDept horizontalByDept2 = horizontalByDept1.OleDB.Create<StatementMonthHorizontalByDept>();
    ...
    public async IAsyncEnumerable<StatementMonthHorizontalByDept> SelectMonthHorizontalByDeptEnumerableAsync(
      object p_param)
    {
      StatementMonthHorizontalByDept horizontalByDept1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

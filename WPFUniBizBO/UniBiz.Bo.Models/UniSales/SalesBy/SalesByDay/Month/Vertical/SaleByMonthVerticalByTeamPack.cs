...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Month.Vertical.SaleByMonthVerticalByTeamPack
...
{
  public class SaleByMonthVerticalByTeamPack : BindableBase
  {
    private IList<DeptView> _DataHeader;
    private SaleByMonthVerticalByTeamDic _DataBody;
    ...
    public SaleByMonthVerticalByTeamDic DataBody
    {
      get => this._DataBody;
      set
      {

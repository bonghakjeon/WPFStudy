...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Month.Vertical.SaleByMonthVerticalByCategoryTop
...
{
  public class SaleByMonthVerticalByCategoryTop : 
    SaleByMonthVerticalByDept<SaleByMonthVerticalByCategoryTop>
  {
    ...
    public override string ToString() => string.Format("{0} [{1}] Count : {2}", (object) nameof (SaleByMonthVerticalByCategoryTop), (object) this.sbd_SaleDate, (object) this.Lt_Details.Count);
    ...
    public void Add(SaleByMonthVerticalByCategoryTop item)
    {
    ...
    public void AddRange(IList<SaleByMonthVerticalByCategoryTop> infos)
    {
      foreach (SaleByMonthVerticalByCategoryTop info in (IEnumerable<SaleByMonthVerticalByCategoryTop>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, SaleByMonthVerticalByCategoryTop pSource) => pSource == null || this.IsZero(pCheckType, (SaleByMonthVerticalByDept) pSource);
    ...
    public async Task<IList<SaleByMonthVerticalByCategoryTop>> SelectMonthVerticalByCategoryTopListAsync(
      object p_param)
    {
      SaleByMonthVerticalByCategoryTop verticalByCategoryTop1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(verticalByCategoryTop1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<SaleByMonthVerticalByCategoryTop>) null;
        }
        IList<SaleByMonthVerticalByCategoryTop> lt_list = (IList<SaleByMonthVerticalByCategoryTop>) new List<SaleByMonthVerticalByCategoryTop>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            SaleByMonthVerticalByCategoryTop verticalByCategoryTop2 = verticalByCategoryTop1.OleDB.Create<SaleByMonthVerticalByCategoryTop>();
    ...
    public async IAsyncEnumerable<SaleByMonthVerticalByCategoryTop> SelectMonthVerticalByCategoryTopEnumerableAsync(
      object p_param)
    {
      SaleByMonthVerticalByCategoryTop verticalByCategoryTop1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;
    ...
    public override string GetSelectQuery(object p_param) => new SalesByMonthHorizontalByCategoryTop().GetSelectQuery(p_param);
  }
}

...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Day.Horizontal.SalesByDayHorizontalByGoodsPack
...
{
  public class SalesByDayHorizontalByGoodsPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private SalesByDayHorizontalByGoodsDic _DataBody;
    ...
    public SalesByDayHorizontalByGoodsDic DataBody
    {
      get => this._DataBody;
      set
      {

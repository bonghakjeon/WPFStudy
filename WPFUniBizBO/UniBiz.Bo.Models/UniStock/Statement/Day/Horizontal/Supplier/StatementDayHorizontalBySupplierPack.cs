...
// Type: UniBiz.Bo.Models.UniStock.Statement.Day.Horizontal.Supplier.StatementDayHorizontalBySupplierPack
...
{
  public class StatementDayHorizontalBySupplierPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private StatementDayHorizontalBySupplierDic _DataBody;
    ...
    public StatementDayHorizontalBySupplierDic DataBody
    {
      get => this._DataBody;
      set
      {

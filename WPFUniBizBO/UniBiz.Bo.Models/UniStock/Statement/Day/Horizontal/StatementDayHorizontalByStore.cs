...
// Type: UniBiz.Bo.Models.UniStock.Statement.Day.Horizontal.StatementDayHorizontalByStore
...
{
  public class StatementDayHorizontalByStore : StatementDayHorizontal<StatementDayHorizontalByStore>
  {
    ...
    public override string ToString() => string.Format("{0} [{1}:{2}] Count : {3}", (object) nameof (StatementDayHorizontalByStore), (object) this.si_StoreName, (object) this.sh_StoreCode, (object) this.Lt_Details.Count);
    ...
    public void PutInfo(StatementDayHorizontalByStore pSource)
    {
    ...
    public void Add(StatementDayHorizontalByStore item)
    {
    ...
    public void AddRange(IList<StatementDayHorizontalByStore> infos)
    {
      foreach (StatementDayHorizontalByStore info in (IEnumerable<StatementDayHorizontalByStore>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, StatementDayHorizontalByStore pSource) => pSource == null || this.IsZero(pCheckType, (StatementDayHorizontal) pSource);
    ...
    public async Task<IList<StatementDayHorizontalByStore>> SelectDayHorizontalByStoreListAsync(
      object p_param)
    {
      StatementDayHorizontalByStore horizontalByStore1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(horizontalByStore1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<StatementDayHorizontalByStore>) null;
        }
        IList<StatementDayHorizontalByStore> lt_list = (IList<StatementDayHorizontalByStore>) new List<StatementDayHorizontalByStore>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            StatementDayHorizontalByStore horizontalByStore2 = horizontalByStore1.OleDB.Create<StatementDayHorizontalByStore>();
    ...
    public async IAsyncEnumerable<StatementDayHorizontalByStore> SelectDayHorizontalByStoreEnumerableAsync(
      object p_param)
    {
      StatementDayHorizontalByStore horizontalByStore1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

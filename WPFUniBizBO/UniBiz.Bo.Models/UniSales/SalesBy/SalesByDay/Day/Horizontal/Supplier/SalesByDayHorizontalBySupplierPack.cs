...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Day.Horizontal.Supplier.SalesByDayHorizontalBySupplierPack
...
{
  public class SalesByDayHorizontalBySupplierPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private SalesByDayHorizontalBySupplierDic _DataBody;
    ...
    public SalesByDayHorizontalBySupplierDic DataBody
    {
      get => this._DataBody;
      set
      {

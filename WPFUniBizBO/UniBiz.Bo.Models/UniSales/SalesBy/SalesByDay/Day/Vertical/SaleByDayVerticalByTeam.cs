...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Day.Vertical.SaleByDayVerticalByTeam
...
{
  public class SaleByDayVerticalByTeam : SaleByDayVerticalByStore<SaleByDayVerticalByTeam>
  {
    ...
    public override string ToString() => string.Format("{0} [{1}] Count : {2}", (object) nameof (SaleByDayVerticalByTeam), (object) this.sbd_SaleDate, (object) this.Lt_Details.Count);
    ...
    public void Add(SaleByDayVerticalByTeam item)
    {
    ...
    public void AddRange(IList<SaleByDayVerticalByTeam> infos)
    {
      foreach (SaleByDayVerticalByTeam info in (IEnumerable<SaleByDayVerticalByTeam>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, SaleByDayVerticalByTeam pSource) => pSource == null || this.IsZero(pCheckType, (SaleByDayVerticalByStore) pSource);
    ...
    public async Task<IList<SaleByDayVerticalByTeam>> SelectDayVerticalByTeamListAsync(
      object p_param)
    {
      SaleByDayVerticalByTeam dayVerticalByTeam1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(dayVerticalByTeam1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<SaleByDayVerticalByTeam>) null;
        }
        IList<SaleByDayVerticalByTeam> lt_list = (IList<SaleByDayVerticalByTeam>) new List<SaleByDayVerticalByTeam>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            SaleByDayVerticalByTeam dayVerticalByTeam2 = dayVerticalByTeam1.OleDB.Create<SaleByDayVerticalByTeam>();
    ...
    public async IAsyncEnumerable<SaleByDayVerticalByTeam> SelectDayVerticalByTeamEnumerableAsync(
      object p_param)
    {
      SaleByDayVerticalByTeam dayVerticalByTeam1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;
    ...
    public override string GetSelectQuery(object p_param) => new SalesByDayHorizontalByTeam().GetSelectQuery(p_param);
  }
}

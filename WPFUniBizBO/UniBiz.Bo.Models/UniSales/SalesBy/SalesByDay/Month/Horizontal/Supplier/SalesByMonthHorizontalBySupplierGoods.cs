...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Month.Horizontal.Supplier.SalesByMonthHorizontalBySupplierGoods
...
{
  public class SalesByMonthHorizontalBySupplierGoods : 
    SalesByMonthHorizontalBySupplierCategoryBot<SalesByMonthHorizontalBySupplierGoods>
  {
    ...
    public override string KeyCode => string.Format("{0}|{1}|{2}|{3}|{4}|{5}", (object) this.si_StoreCode, (object) this.sbd_Supplier, (object) this.ctg_lv1_ID, (object) this.ctg_lv2_ID, (object) this.sbd_CategoryCode, (object) this.sbd_GoodsCode);
    ...
    public override string ToString() => string.Format("{0} [{1}({2})][{3}({4})] Count : {5}", (object) nameof (SalesByMonthHorizontalBySupplierGoods), (object) this.su_SupplierName, (object) this.sbd_Supplier, (object) this.gd_GoodsName, (object) this.gd_BarCode, (object) this.Lt_Details.Count);
    ...
    public void PutInfo(SalesByMonthHorizontalBySupplierGoods pSource)
    {
      this.PutInfo((SalesByMonthHorizontalBySupplierCategoryBot) pSource);
    ...
    public void InitInfo(SalesByMonthHorizontalBySupplierGoods pData, IList<DateTime> p_Days)
    {
      if (!this.KeyCode.Equals(pData.KeyCode))
        throw new Exception("pData 의 [sbd_StoreCode|sbd_Supplier|ctg_lv1_ID|ctg_lv2_ID|sbd_CategoryCode|sbd_GoodsCode] 이 KeyCode 와 다릅니다");
      this.PutInfo(pData);
    ...
    public void Add(SalesByMonthHorizontalBySupplierGoods item)
    {
      if (this.si_StoreCode == 0)
      {
        ...
        throw new Exception("item 의 [sbd_StoreCode|sbd_Supplier|ctg_lv1_ID|ctg_lv2_ID|sbd_CategoryCode|sbd_GoodsCode] 이 KeyCode 와 다릅니다");
    ...
    public void AddRange(IList<SalesByMonthHorizontalBySupplierGoods> infos)
    {
      foreach (SalesByMonthHorizontalBySupplierGoods info in (IEnumerable<SalesByMonthHorizontalBySupplierGoods>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, SalesByMonthHorizontalBySupplierGoods pSource) => pSource == null || this.IsZero(pCheckType, (SalesByMonthHorizontalBySupplierCategoryBot) pSource);
    ...
    public async Task<IList<SalesByMonthHorizontalBySupplierGoods>> SelectMonthHorizontalBySupplierGoodsListAsync(
      object p_param)
    {
      SalesByMonthHorizontalBySupplierGoods horizontalBySupplierGoods1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(horizontalBySupplierGoods1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<SalesByMonthHorizontalBySupplierGoods>) null;
        }
        IList<SalesByMonthHorizontalBySupplierGoods> lt_list = (IList<SalesByMonthHorizontalBySupplierGoods>) new List<SalesByMonthHorizontalBySupplierGoods>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            SalesByMonthHorizontalBySupplierGoods horizontalBySupplierGoods2 = horizontalBySupplierGoods1.OleDB.Create<SalesByMonthHorizontalBySupplierGoods>();
    ...
    public async IAsyncEnumerable<SalesByMonthHorizontalBySupplierGoods> SelectMonthHorizontalBySupplierGoodsEnumerableAsync(
      object p_param)
    {
      SalesByMonthHorizontalBySupplierGoods horizontalBySupplierGoods1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

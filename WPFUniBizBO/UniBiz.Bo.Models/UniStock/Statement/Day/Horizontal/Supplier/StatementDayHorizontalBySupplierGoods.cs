...
// Type: UniBiz.Bo.Models.UniStock.Statement.Day.Horizontal.Supplier.StatementDayHorizontalBySupplierGoods
...
{
  public class StatementDayHorizontalBySupplierGoods : 
    StatementDayHorizontalBySupplierCatBot<StatementDayHorizontalBySupplierGoods>
  {
    ...
    public override string ToString() => string.Format("{0} [{1}({2})][{3}({4})] Count : {5}", (object) nameof (StatementDayHorizontalBySupplierGoods), (object) this.su_SupplierName, (object) this.sh_Supplier, (object) this.gd_GoodsName, (object) this.gd_BarCode, (object) this.Lt_Details.Count);
    ...
    public void PutInfo(StatementDayHorizontalBySupplierGoods pSource)
    {
      this.PutInfo((StatementDayHorizontalBySupplierCatBot) pSource);
    ...
    public void Add(StatementDayHorizontalBySupplierGoods item)
    {
    ...
    public void AddRange(IList<StatementDayHorizontalBySupplierGoods> infos)
    {
      foreach (StatementDayHorizontalBySupplierGoods info in (IEnumerable<StatementDayHorizontalBySupplierGoods>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, StatementDayHorizontalBySupplierGoods pSource) => pSource == null || this.IsZero(pCheckType, (StatementDayHorizontalBySupplierCatBot) pSource);
    ...
    public async Task<IList<StatementDayHorizontalBySupplierGoods>> SelectDayHorizontalBySupplierGoodsListAsync(
      object p_param)
    {
      StatementDayHorizontalBySupplierGoods horizontalBySupplierGoods1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(horizontalBySupplierGoods1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<StatementDayHorizontalBySupplierGoods>) null;
        }
        IList<StatementDayHorizontalBySupplierGoods> lt_list = (IList<StatementDayHorizontalBySupplierGoods>) new List<StatementDayHorizontalBySupplierGoods>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            StatementDayHorizontalBySupplierGoods horizontalBySupplierGoods2 = horizontalBySupplierGoods1.OleDB.Create<StatementDayHorizontalBySupplierGoods>();
    ...
    public async IAsyncEnumerable<StatementDayHorizontalBySupplierGoods> SelectDayHorizontalBySupplierGoodsEnumerableAsync(
      object p_param)
    {
      StatementDayHorizontalBySupplierGoods horizontalBySupplierGoods1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

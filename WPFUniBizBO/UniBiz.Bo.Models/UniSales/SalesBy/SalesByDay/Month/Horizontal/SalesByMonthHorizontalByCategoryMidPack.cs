...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Month.Horizontal.SalesByMonthHorizontalByCategoryMidPack
...
{
  public class SalesByMonthHorizontalByCategoryMidPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private SalesByMonthHorizontalByCategoryMidDic _DataBody;
    ...
    public SalesByMonthHorizontalByCategoryMidDic DataBody
    {
      get => this._DataBody;
      set
      {

...
// Type: UniBiz.Bo.Models.UniStock.Statement.Day.Horizontal.Supplier.StatementDayHorizontalBySupplierCatTop
...
{
  public class StatementDayHorizontalBySupplierCatTop : 
    StatementDayHorizontalBySupplier<StatementDayHorizontalBySupplierCatTop>
  {
    ...
    public override string ToString() => string.Format("{0} [{1}({2})][{3}] Count : {4}", (object) nameof (StatementDayHorizontalBySupplierCatTop), (object) this.su_SupplierName, (object) this.sh_Supplier, (object) this.ctg_lv1_Name, (object) this.Lt_Details.Count);
    ...
    public void PutInfo(StatementDayHorizontalBySupplierCatTop pSource)
    {
      this.PutInfo((StatementDayHorizontalBySupplier) pSource);
    ...
    public void Add(StatementDayHorizontalBySupplierCatTop item)
    {
    ...
    public void AddRange(
      IList<StatementDayHorizontalBySupplierCatTop> infos)
    {
      foreach (StatementDayHorizontalBySupplierCatTop info in (IEnumerable<StatementDayHorizontalBySupplierCatTop>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, StatementDayHorizontalBySupplierCatTop pSource) => pSource == null || this.IsZero(pCheckType, (StatementDayHorizontalBySupplier) pSource);
    ...
    public async Task<IList<StatementDayHorizontalBySupplierCatTop>> SelectDayHorizontalBySupplierCatTopListAsync(
      object p_param)
    {
      StatementDayHorizontalBySupplierCatTop bySupplierCatTop1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(bySupplierCatTop1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<StatementDayHorizontalBySupplierCatTop>) null;
        }
        IList<StatementDayHorizontalBySupplierCatTop> lt_list = (IList<StatementDayHorizontalBySupplierCatTop>) new List<StatementDayHorizontalBySupplierCatTop>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            StatementDayHorizontalBySupplierCatTop bySupplierCatTop2 = bySupplierCatTop1.OleDB.Create<StatementDayHorizontalBySupplierCatTop>();
    ...
    public async IAsyncEnumerable<StatementDayHorizontalBySupplierCatTop> SelectDayHorizontalBySupplierCatTopEnumerableAsync(
      object p_param)
    {
      StatementDayHorizontalBySupplierCatTop bySupplierCatTop1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Month.Vertical.SaleByMonthVerticalByCategoryBotPack
...
{
  public class SaleByMonthVerticalByCategoryBotPack : BindableBase
  {
    private IList<CategoryView> _DataHeader;
    private SaleByMonthVerticalByCategoryBotDic _DataBody;
    ...
    public SaleByMonthVerticalByCategoryBotDic DataBody
    {
      get => this._DataBody;
      set
      {

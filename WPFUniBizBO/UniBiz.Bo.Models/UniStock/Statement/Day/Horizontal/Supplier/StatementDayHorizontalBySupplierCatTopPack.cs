...
// Type: UniBiz.Bo.Models.UniStock.Statement.Day.Horizontal.Supplier.StatementDayHorizontalBySupplierCatTopPack
...
{
  public class StatementDayHorizontalBySupplierCatTopPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private StatementDayHorizontalBySupplierCatTopDic _DataBody;
    ...
    public StatementDayHorizontalBySupplierCatTopDic DataBody
    {
      get => this._DataBody;
      set
      {

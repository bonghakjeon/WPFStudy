...
// Type: UniBiz.Bo.Models.UniStock.Profit.ProfitLossSummary.Date.ProfitLossSummaryDateCategoryMid
...
{
  public class ProfitLossSummaryDateCategoryMid : 
    ProfitLossSummaryDateCategoryTop<ProfitLossSummaryDateCategoryMid>
  {
    ...
    protected override UbModelBase CreateClone => (UbModelBase) new ProfitLossSummaryDateCategoryMid();

    public override object Clone()
    {
      ProfitLossSummaryDateCategoryMid summaryDateCategoryMid = base.Clone() as ProfitLossSummaryDateCategoryMid;
      summaryDateCategoryMid.ctg_lv2_ID = this.ctg_lv2_ID;
      summaryDateCategoryMid.ctg_lv2_ViewCode = this.ctg_lv2_ViewCode;
      summaryDateCategoryMid.ctg_lv2_Name = this.ctg_lv2_Name;
      return (object) summaryDateCategoryMid;
    }

    public void PutData(ProfitLossSummaryDateCategoryMid pSource)
    {
      this.PutData((ProfitLossSummaryDateCategoryTop) pSource);
      this.ctg_lv2_ID = pSource.ctg_lv2_ID;
      this.ctg_lv2_ViewCode = pSource.ctg_lv2_ViewCode;
      this.ctg_lv2_Name = pSource.ctg_lv2_Name;
    }

    public bool IsZero(EnumZeroCheck pCheckType, ProfitLossSummaryDateCategoryMid pSource) => pSource == null || this.IsZero(pCheckType, (ProfitLossSummaryDateCategoryTop) pSource);
    ...
    public async Task<IList<ProfitLossSummaryDateCategoryMid>> SelectDateCategoryMidListAsync(
      object p_param)
    {
      ProfitLossSummaryDateCategoryMid summaryDateCategoryMid1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;
      UniOleDatabase db = (UniOleDatabase) null;
      try
      {
        db = new UniOleDatabase(summaryDateCategoryMid1.OleDB.ConnectionUrl);
        rs = new UniOleDbRecordset(db, summaryDateCategoryMid1.OleDB.CommandTimeout);
        if (!await rs.OpenAsync(summaryDateCategoryMid1.GetSelectQuery(p_param)))
        {
          summaryDateCategoryMid1.SetErrorInfo(rs.LastErrorID, "검색 오류 - SQL OPEN 실패\n--------------------------------------------------------------------------------------------------\n 테이블 : " + summaryDateCategoryMid1.TableCode.ToDescription() + "\n 메소드 : " + MethodBase.GetCurrentMethod().ReflectedType.Name + "==>" + MethodBase.GetCurrentMethod().Name + "\n" + string.Format(" LINE : {0} 행\n", (object) new StackFrame(0, true).GetFileLineNumber()) + "--------------------------------------------------------------------------------------------------\n" + string.Format(" 에러 : {0}\n", (object) rs.LastErrorID) + " 내용 : " + rs.LastErrorMessage + "\n--------------------------------------------------------------------------------------------------\n");
          return (IList<ProfitLossSummaryDateCategoryMid>) null;
        }
        IList<ProfitLossSummaryDateCategoryMid> lt_list = (IList<ProfitLossSummaryDateCategoryMid>) new List<ProfitLossSummaryDateCategoryMid>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            ProfitLossSummaryDateCategoryMid summaryDateCategoryMid2 = summaryDateCategoryMid1.OleDB.Create<ProfitLossSummaryDateCategoryMid>();
            if (summaryDateCategoryMid2.GetFieldValues(rs))
            {
              summaryDateCategoryMid2.row_number = lt_list.Count + 1;
              lt_list.Add(summaryDateCategoryMid2);
            }
          }
    ...
    public async IAsyncEnumerable<ProfitLossSummaryDateCategoryMid> SelectDateCategoryMidEnumerableAsync(
      object p_param)
    {
      ProfitLossSummaryDateCategoryMid summaryDateCategoryMid1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;
      ...
      try
      {
        ...
        else if (await rs.IsDataReadAsync())
        {
          ...
          do
          {
            ...
            if (summaryDateCategoryMid2.GetFieldValues(rs))
            {
              summaryDateCategoryMid2.row_number = ++row_number;
              yield return summaryDateCategoryMid2;
            }
          }
          while (await rs.IsDataReadAsync());
        }
    ...
    public override string GetSelectQuery(object p_param)
    {
      ...
      try
      {
        ...
        if (flag1)
        {
          ...
          stringBuilder1.Append(",ctg_lv1_ID,ctg_lv2_ID");

...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Day.Horizontal.Supplier.SalesByDayHorizontalBySupplierCategoryMidPack
...
{
  public class SalesByDayHorizontalBySupplierCategoryMidPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private SalesByDayHorizontalBySupplierCategoryMidDic _DataBody;
    ...
    public SalesByDayHorizontalBySupplierCategoryMidDic DataBody
    {
      get => this._DataBody;
      set
      {

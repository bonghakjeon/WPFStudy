...
// Type: UniBiz.Bo.Models.UniStock.Statement.Month.Horizontal.Supplier.StatementMonthHorizontalBySupplierCatTopPack
...
{
  public class StatementMonthHorizontalBySupplierCatTopPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private StatementMonthHorizontalBySupplierCatTopDic _DataBody;
    ...
    public StatementMonthHorizontalBySupplierCatTopDic DataBody
    {
      get => this._DataBody;
      set
      {

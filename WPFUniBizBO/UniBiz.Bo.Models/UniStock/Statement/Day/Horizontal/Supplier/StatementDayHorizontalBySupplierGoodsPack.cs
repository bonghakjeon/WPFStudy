...
// Type: UniBiz.Bo.Models.UniStock.Statement.Day.Horizontal.Supplier.StatementDayHorizontalBySupplierGoodsPack
...
{
  public class StatementDayHorizontalBySupplierGoodsPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private StatementDayHorizontalBySupplierGoodsDic _DataBody;
    ...
    public StatementDayHorizontalBySupplierGoodsDic DataBody
    {
      get => this._DataBody;
      set
      {

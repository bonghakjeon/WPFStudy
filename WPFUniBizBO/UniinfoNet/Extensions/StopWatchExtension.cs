...
// Type: UniinfoNet.Extensions.StopWatchExtension
...
namespace UniinfoNet.Extensions
{
  ...
  {
    public static string ToInfoString(this Stopwatch obj) => string.Format("Running {0}\t{1}", (object) obj.IsRunning, (object) obj.Elapsed.ToString("G"));
  }
}

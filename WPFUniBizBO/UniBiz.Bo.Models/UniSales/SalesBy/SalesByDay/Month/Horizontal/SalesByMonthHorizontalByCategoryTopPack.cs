...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Month.Horizontal.SalesByMonthHorizontalByCategoryTopPack
...
{
  public class SalesByMonthHorizontalByCategoryTopPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private SalesByMonthHorizontalByCategoryTopDic _DataBody;
    ...
    public SalesByMonthHorizontalByCategoryTopDic DataBody
    {
      get => this._DataBody;
      set
      {

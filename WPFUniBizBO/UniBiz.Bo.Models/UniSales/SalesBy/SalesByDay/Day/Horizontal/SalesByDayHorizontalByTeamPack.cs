...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Day.Horizontal.SalesByDayHorizontalByTeamPack
...
{
  public class SalesByDayHorizontalByTeamPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private SalesByDayHorizontalByTeamDic _DataBody;
    ...
    public SalesByDayHorizontalByTeamDic DataBody
    {
      get => this._DataBody;
      set
      {

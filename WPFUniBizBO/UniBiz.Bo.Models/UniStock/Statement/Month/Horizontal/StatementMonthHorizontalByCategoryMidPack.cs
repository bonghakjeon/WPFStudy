...
// Type: UniBiz.Bo.Models.UniStock.Statement.Month.Horizontal.StatementMonthHorizontalByCategoryMidPack
...
{
  public class StatementMonthHorizontalByCategoryMidPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private StatementMonthHorizontalByCategoryMidDic _DataBody;
    ...
    public StatementMonthHorizontalByCategoryMidDic DataBody
    {
      get => this._DataBody;
      set
      {

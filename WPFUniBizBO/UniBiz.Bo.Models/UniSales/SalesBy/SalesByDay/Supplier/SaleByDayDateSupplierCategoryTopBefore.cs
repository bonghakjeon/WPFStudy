...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Supplier.SaleByDayDateSupplierCategoryTopBefore
...
{
  public class SaleByDayDateSupplierCategoryTopBefore : 
    SaleByDayDateSupplierBefore<SaleByDayDateSupplierCategoryTopBefore>
  {
    ...
    protected override UbModelBase CreateClone => (UbModelBase) new SaleByDayDateSupplierCategoryTopBefore();

    public override object Clone()
    {
      SaleByDayDateSupplierCategoryTopBefore categoryTopBefore = base.Clone() as SaleByDayDateSupplierCategoryTopBefore;
    ...
    public void PutData(SaleByDayDateSupplierCategoryTopBefore pSource)
    {
      this.PutData((SaleByDayDateSupplierBefore) pSource);
      this.ctg_lv1_ID = pSource.ctg_lv1_ID;
      this.ctg_lv1_ViewCode = pSource.ctg_lv1_ViewCode;
      this.ctg_lv1_Name = pSource.ctg_lv1_Name;
    }

    public bool IsZero(EnumZeroCheck pCheckType, SaleByDayDateSupplierCategoryTopBefore pSource) => pSource == null || this.IsZero(pCheckType, (SaleByDayDateSupplierBefore) pSource);
    ...
    public async Task<IList<SaleByDayDateSupplierCategoryTopBefore>> SelectDateSupplierCategoryTopBeforeListAsync(
      object p_param)
    {
      SaleByDayDateSupplierCategoryTopBefore categoryTopBefore1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(categoryTopBefore1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<SaleByDayDateSupplierCategoryTopBefore>) null;
        }
        IList<SaleByDayDateSupplierCategoryTopBefore> lt_list = (IList<SaleByDayDateSupplierCategoryTopBefore>) new List<SaleByDayDateSupplierCategoryTopBefore>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            SaleByDayDateSupplierCategoryTopBefore categoryTopBefore2 = categoryTopBefore1.OleDB.Create<SaleByDayDateSupplierCategoryTopBefore>();
    ...
    public async IAsyncEnumerable<SaleByDayDateSupplierCategoryTopBefore> SelectDateSupplierCategoryTopBeforeEnumerableAsync(
      object p_param)
    {
      SaleByDayDateSupplierCategoryTopBefore categoryTopBefore1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

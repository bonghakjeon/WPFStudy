...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Month.Horizontal.SalesByMonthHorizontalByGoods
...
{
  public class SalesByMonthHorizontalByGoods : 
    SalesByMonthHorizontalByCategoryBot<SalesByMonthHorizontalByGoods>
  {
    ...
    public void PutInfo(SalesByMonthHorizontalByGoods pSource)
    {
      this.PutInfo((SalesByMonthHorizontalByCategoryBot) pSource);
    ...
    public void InitInfo(SalesByMonthHorizontalByGoods pData, IList<DateTime> p_Days)
    {
      ...
      foreach (DateTime pDay in (IEnumerable<DateTime>) p_Days)
      {
        ...
        salesByMonthGoal.sbd_GoodsCode = this.sbd_GoodsCode;
        ltDetails.Add((SalesByDayGoal) salesByMonthGoal);
      }
    }

    public void Add(SalesByMonthHorizontalByGoods item)
    {
    ...
    public void AddRange(IList<SalesByMonthHorizontalByGoods> infos)
    {
      foreach (SalesByMonthHorizontalByGoods info in (IEnumerable<SalesByMonthHorizontalByGoods>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, SalesByMonthHorizontalByGoods pSource) => pSource == null || this.IsZero(pCheckType, (SalesByMonthHorizontalByCategoryBot) pSource);
    ...
    public async Task<IList<SalesByMonthHorizontalByGoods>> SelectMonthHorizontalByGoodsListAsync(
      object p_param)
    {
      SalesByMonthHorizontalByGoods horizontalByGoods1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(horizontalByGoods1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<SalesByMonthHorizontalByGoods>) null;
        }
        IList<SalesByMonthHorizontalByGoods> lt_list = (IList<SalesByMonthHorizontalByGoods>) new List<SalesByMonthHorizontalByGoods>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            SalesByMonthHorizontalByGoods horizontalByGoods2 = horizontalByGoods1.OleDB.Create<SalesByMonthHorizontalByGoods>();
    ...
    public async IAsyncEnumerable<SalesByMonthHorizontalByGoods> SelectMonthHorizontalByGoodsEnumerableAsync(
      object p_param)
    {
      SalesByMonthHorizontalByGoods horizontalByGoods1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Month.Horizontal.SalesByMonthHorizontalByStorePack
...
{
  public class SalesByMonthHorizontalByStorePack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private SalesByMonthHorizontalByStoreDic _DataBody;
    ...
    public SalesByMonthHorizontalByStoreDic DataBody
    {
      get => this._DataBody;
      set
      {

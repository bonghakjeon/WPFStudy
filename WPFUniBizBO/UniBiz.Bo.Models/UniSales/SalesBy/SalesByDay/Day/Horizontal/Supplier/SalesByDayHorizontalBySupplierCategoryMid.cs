...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Day.Horizontal.Supplier.SalesByDayHorizontalBySupplierCategoryMid
...
{
  public class SalesByDayHorizontalBySupplierCategoryMid : 
    SalesByDayHorizontalBySupplierCategoryTop<SalesByDayHorizontalBySupplierCategoryMid>
  {
    ...
    public override string ToString() => string.Format("{0} [{1}({2})][{3}>{4}] Count : {5}", (object) nameof (SalesByDayHorizontalBySupplierCategoryMid), (object) this.su_SupplierName, (object) this.sbd_Supplier, (object) this.ctg_lv1_Name, (object) this.ctg_lv2_Name, (object) this.Lt_Details.Count);
    ...
    public void PutInfo(SalesByDayHorizontalBySupplierCategoryMid pSource)
    {
      this.PutInfo((SalesByDayHorizontalBySupplierCategoryTop) pSource);
    ...
    public void Add(SalesByDayHorizontalBySupplierCategoryMid item)
    {
    ...
    public void AddRange(
      IList<SalesByDayHorizontalBySupplierCategoryMid> infos)
    {
      foreach (SalesByDayHorizontalBySupplierCategoryMid info in (IEnumerable<SalesByDayHorizontalBySupplierCategoryMid>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, SalesByDayHorizontalBySupplierCategoryMid pSource) => pSource == null || this.IsZero(pCheckType, (SalesByDayHorizontalBySupplierCategoryTop) pSource);
    ...
    public async Task<IList<SalesByDayHorizontalBySupplierCategoryMid>> SelectDayHorizontalBySupplierCategoryMidListAsync(
      object p_param)
    {
      SalesByDayHorizontalBySupplierCategoryMid supplierCategoryMid1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(supplierCategoryMid1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<SalesByDayHorizontalBySupplierCategoryMid>) null;
        }
        IList<SalesByDayHorizontalBySupplierCategoryMid> lt_list = (IList<SalesByDayHorizontalBySupplierCategoryMid>) new List<SalesByDayHorizontalBySupplierCategoryMid>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            SalesByDayHorizontalBySupplierCategoryMid supplierCategoryMid2 = supplierCategoryMid1.OleDB.Create<SalesByDayHorizontalBySupplierCategoryMid>();
    ...
    public async IAsyncEnumerable<SalesByDayHorizontalBySupplierCategoryMid> SelectDayHorizontalBySupplierCategoryMidEnumerableAsync(
      object p_param)
    {
      SalesByDayHorizontalBySupplierCategoryMid supplierCategoryMid1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

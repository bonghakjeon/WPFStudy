...
// Type: UniBiz.Bo.Models.UniStock.Statement.Month.Horizontal.Supplier.StatementMonthHorizontalBySupplierCatMidPack
...
{
  public class StatementMonthHorizontalBySupplierCatMidPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private StatementMonthHorizontalBySupplierCatMidDic _DataBody;
    ...
    public StatementMonthHorizontalBySupplierCatMidDic DataBody
    {
      get => this._DataBody;
      set
      {

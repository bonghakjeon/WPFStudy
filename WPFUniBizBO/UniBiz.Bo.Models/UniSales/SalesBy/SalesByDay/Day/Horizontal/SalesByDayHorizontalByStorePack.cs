...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Day.Horizontal.SalesByDayHorizontalByStorePack
...
{
  public class SalesByDayHorizontalByStorePack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private SalesByDayHorizontalByStoreDic _DataBody;
    ...
    public SalesByDayHorizontalByStoreDic DataBody
    {
      get => this._DataBody;
      set
      {

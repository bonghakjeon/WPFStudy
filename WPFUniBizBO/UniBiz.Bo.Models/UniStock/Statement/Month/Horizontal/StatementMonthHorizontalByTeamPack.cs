...
// Type: UniBiz.Bo.Models.UniStock.Statement.Month.Horizontal.StatementMonthHorizontalByTeamPack
...
{
  public class StatementMonthHorizontalByTeamPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private StatementMonthHorizontalByTeamDic _DataBody;
    ...
    public StatementMonthHorizontalByTeamDic DataBody
    {
      get => this._DataBody;
      set
      {

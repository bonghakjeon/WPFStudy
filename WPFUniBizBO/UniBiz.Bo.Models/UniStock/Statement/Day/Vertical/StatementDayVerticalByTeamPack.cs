...
// Type: UniBiz.Bo.Models.UniStock.Statement.Day.Vertical.StatementDayVerticalByTeamPack
...
{
  public class StatementDayVerticalByTeamPack : BindableBase
  {
    private IList<DeptView> _DataHeader;
    private StatementDayVerticalByTeamDic _DataBody;
    ...
    public StatementDayVerticalByTeamDic DataBody
    {
      get => this._DataBody;
      set
      {

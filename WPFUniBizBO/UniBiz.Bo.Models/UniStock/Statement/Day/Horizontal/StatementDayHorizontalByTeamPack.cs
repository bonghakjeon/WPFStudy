...
// Type: UniBiz.Bo.Models.UniStock.Statement.Day.Horizontal.StatementDayHorizontalByTeamPack
...
{
  public class StatementDayHorizontalByTeamPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private StatementDayHorizontalByTeamDic _DataBody;
    ...
    public StatementDayHorizontalByTeamDic DataBody
    {
      get => this._DataBody;
      set
      {

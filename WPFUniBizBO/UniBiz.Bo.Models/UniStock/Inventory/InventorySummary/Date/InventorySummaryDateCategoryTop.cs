...
// Type: UniBiz.Bo.Models.UniStock.Inventory.InventorySummary.Date.InventorySummaryDateCategoryTop
...
{
  public class InventorySummaryDateCategoryTop : 
    InventorySummaryDateDept<InventorySummaryDateCategoryTop>
  {
    ...
    protected override UbModelBase CreateClone => (UbModelBase) new InventorySummaryDateCategoryTop();

    public override object Clone()
    {
      InventorySummaryDateCategoryTop summaryDateCategoryTop = base.Clone() as InventorySummaryDateCategoryTop;
    ...
    public void PutData(InventorySummaryDateCategoryTop pSource)
    {
      this.PutData((InventorySummaryDateDept) pSource);
      this.ctg_lv1_ID = pSource.ctg_lv1_ID;
      this.ctg_lv1_ViewCode = pSource.ctg_lv1_ViewCode;
      this.ctg_lv1_Name = pSource.ctg_lv1_Name;
    }

    public bool IsZero(EnumZeroCheck pCheckType, InventorySummaryDateCategoryTop pSource) => pSource == null || this.IsZero(pCheckType, (InventorySummaryDateDept) pSource);
    ...
    public async Task<IList<InventorySummaryDateCategoryTop>> SelectDateCategoryTopListAsync(
      object p_param)
    {
      InventorySummaryDateCategoryTop summaryDateCategoryTop1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(summaryDateCategoryTop1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<InventorySummaryDateCategoryTop>) null;
        }
        IList<InventorySummaryDateCategoryTop> lt_list = (IList<InventorySummaryDateCategoryTop>) new List<InventorySummaryDateCategoryTop>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            InventorySummaryDateCategoryTop summaryDateCategoryTop2 = summaryDateCategoryTop1.OleDB.Create<InventorySummaryDateCategoryTop>();
    ...
    public async IAsyncEnumerable<InventorySummaryDateCategoryTop> SelectDateCategoryTopEnumerableAsync(
      object p_param)
    {
      InventorySummaryDateCategoryTop summaryDateCategoryTop1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

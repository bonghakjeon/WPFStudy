...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Day.Horizontal.Supplier.SalesByDayHorizontalBySupplierCategoryBotPack
...
{
  public class SalesByDayHorizontalBySupplierCategoryBotPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private SalesByDayHorizontalBySupplierCategoryBotDic _DataBody;
    ...
    public SalesByDayHorizontalBySupplierCategoryBotDic DataBody
    {
      get => this._DataBody;
      set
      {

...
// Type: UniBiz.Bo.Models.UniStock.Statement.Day.Horizontal.StatementDayHorizontalByGoodsPack
...
{
  public class StatementDayHorizontalByGoodsPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private StatementDayHorizontalByGoodsDic _DataBody;
    ...
    public StatementDayHorizontalByGoodsDic DataBody
    {
      get => this._DataBody;
      set
      {

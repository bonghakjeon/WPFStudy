...
// Type: UniBiz.Bo.Models.UniStock.Statement.Day.Horizontal.StatementDayHorizontalByCategoryMidPack
...
{
  public class StatementDayHorizontalByCategoryMidPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private StatementDayHorizontalByCategoryMidDic _DataBody;
    ...
    public StatementDayHorizontalByCategoryMidDic DataBody
    {
      get => this._DataBody;
      set
      {

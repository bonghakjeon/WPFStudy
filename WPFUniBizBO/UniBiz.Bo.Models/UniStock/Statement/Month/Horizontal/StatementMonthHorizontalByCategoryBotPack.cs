...
// Type: UniBiz.Bo.Models.UniStock.Statement.Month.Horizontal.StatementMonthHorizontalByCategoryBotPack
...
{
  public class StatementMonthHorizontalByCategoryBotPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private StatementMonthHorizontalByCategoryBotDic _DataBody;
    ...
    public StatementMonthHorizontalByCategoryBotDic DataBody
    {
      get => this._DataBody;
      set
      {

...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Month.Vertical.SaleByMonthVerticalByCategoryMidPack
...
{
  public class SaleByMonthVerticalByCategoryMidPack : BindableBase
  {
    private IList<CategoryView> _DataHeader;
    private SaleByMonthVerticalByCategoryMidDic _DataBody;
    ...
    public SaleByMonthVerticalByCategoryMidDic DataBody
    {
      get => this._DataBody;
      set
      {

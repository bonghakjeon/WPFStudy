...
// Type: UniBizBO.Services.UbConductorOne`1
...
{
  [HiddenVm]
  public class UbConductorOne<TItem> : 
    Conductor<TItem>.Collection.OneActive,
    IUbVM,
    IScreen,
    IViewAware,
    IHaveDisplayName,
    ...
    where TItem : class
  {
    ...
    public UbConductorOne(IContainer container)
    {
    ...
    {
      this.App.Local.Status.LoadManagedStatus<UbConductorOne<TItem>>(this);
      this.IsManagedStatusLoaded = true;
    }

    public void SaveManagedStatus() => this.App.Local.Status.SaveManagedStatus<UbConductorOne<TItem>>(this);

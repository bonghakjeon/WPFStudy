...
// Type: UniinfoNet.TypeKeyNotFoundException
...
{
  public class TypeKeyNotFoundException : TypeKeyException
  {
    ...
    public TypeKeyNotFoundException(string message, Exception innerException)

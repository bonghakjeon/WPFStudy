...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Day.Horizontal.SalesByDayHorizontalByCategoryBot
...
{
  public class SalesByDayHorizontalByCategoryBot : 
    SalesByDayHorizontalByCategoryMid<SalesByDayHorizontalByCategoryBot>
  {
    ...
    public void PutInfo(SalesByDayHorizontalByCategoryBot pSource)
    {
      this.PutInfo((SalesByDayHorizontalByCategoryMid) pSource);
    ...
    public void Add(SalesByDayHorizontalByCategoryBot item)
    {
    ...
    public void AddRange(IList<SalesByDayHorizontalByCategoryBot> infos)
    {
      foreach (SalesByDayHorizontalByCategoryBot info in (IEnumerable<SalesByDayHorizontalByCategoryBot>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, SalesByDayHorizontalByCategoryBot pSource) => pSource == null || this.IsZero(pCheckType, (SalesByDayHorizontalByCategoryMid) pSource);
    ...
    public async Task<IList<SalesByDayHorizontalByCategoryBot>> SelectDayHorizontalByCategoryBotListAsync(
      object p_param)
    {
      SalesByDayHorizontalByCategoryBot horizontalByCategoryBot1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(horizontalByCategoryBot1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<SalesByDayHorizontalByCategoryBot>) null;
        }
        IList<SalesByDayHorizontalByCategoryBot> lt_list = (IList<SalesByDayHorizontalByCategoryBot>) new List<SalesByDayHorizontalByCategoryBot>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            SalesByDayHorizontalByCategoryBot horizontalByCategoryBot2 = horizontalByCategoryBot1.OleDB.Create<SalesByDayHorizontalByCategoryBot>();
    ...
    public async IAsyncEnumerable<SalesByDayHorizontalByCategoryBot> SelectDayHorizontalByCategoryBotEnumerableAsync(
      object p_param)
    {
      SalesByDayHorizontalByCategoryBot horizontalByCategoryBot1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

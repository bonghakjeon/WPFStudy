...
// Type: UniBiz.Bo.Models.UniStock.Statement.Month.Horizontal.Supplier.StatementMonthHorizontalBySupplierCatMid
...
{
  public class StatementMonthHorizontalBySupplierCatMid : 
    StatementMonthHorizontalBySupplierCatTop<StatementMonthHorizontalBySupplierCatMid>
  {
    private int _ctg_lv2_ID;
    private string _ctg_lv2_ViewCode;
    private string _ctg_lv2_Name;

    public override string KeyCode => string.Format("{0}|{1}|{2}|{3}", (object) this.sh_StoreCode, (object) this.sh_Supplier, (object) this.ctg_lv1_ID, (object) this.ctg_lv2_ID);
    ...
    public override string ToString() => string.Format("{0} [{1}({2})][{3}>{4}] Count : {5}", (object) nameof (StatementMonthHorizontalBySupplierCatMid), (object) this.su_SupplierName, (object) this.sh_Supplier, (object) this.ctg_lv1_Name, (object) this.ctg_lv2_Name, (object) this.Lt_Details.Count);
    ...
    public void PutInfo(StatementMonthHorizontalBySupplierCatMid pSource)
    {
      this.PutInfo((StatementMonthHorizontalBySupplierCatTop) pSource);
    ...
    public void InitInfo(StatementMonthHorizontalBySupplierCatMid pData, IList<DateTime> p_Days)
    {
      if (!this.KeyCode.Equals(pData.KeyCode))
        throw new Exception("pData 의 [sh_StoreCode|sh_Supplier|ctg_lv1_ID|ctg_lv2_ID] 이 KeyCode 와 다릅니다");
      this.PutInfo(pData);
    ...
    public void Add(StatementMonthHorizontalBySupplierCatMid item)
    {
      ...
      else
      {
        ...
        if (!this.KeyCode.Equals(item.KeyCode))
          throw new Exception("item 의 [sh_StoreCode|sh_Supplier|ctg_lv1_ID|ctg_lv2_ID] 이 KeyCode 와 다릅니다");
      }
    ...
    public void AddRange(
      IList<StatementMonthHorizontalBySupplierCatMid> infos)
    {
      foreach (StatementMonthHorizontalBySupplierCatMid info in (IEnumerable<StatementMonthHorizontalBySupplierCatMid>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, StatementMonthHorizontalBySupplierCatMid pSource) => pSource == null || this.IsZero(pCheckType, (StatementMonthHorizontalBySupplierCatTop) pSource);
    ...
    public async Task<IList<StatementMonthHorizontalBySupplierCatMid>> SelectMonthHorizontalBySupplierCatMidListAsync(
      object p_param)
    {
      StatementMonthHorizontalBySupplierCatMid bySupplierCatMid1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;
      UniOleDatabase db = (UniOleDatabase) null;
      try
      {
        db = new UniOleDatabase(bySupplierCatMid1.OleDB.ConnectionUrl);
        rs = new UniOleDbRecordset(db, bySupplierCatMid1.OleDB.CommandTimeout);
        if (!await rs.OpenAsync(bySupplierCatMid1.GetSelectQuery(p_param)))
        {
          bySupplierCatMid1.SetErrorInfo(rs.LastErrorID, "검색 오류 - SQL OPEN 실패\n--------------------------------------------------------------------------------------------------\n 테이블 : " + bySupplierCatMid1.TableCode.ToDescription() + "\n 메소드 : " + MethodBase.GetCurrentMethod().ReflectedType.Name + "==>" + MethodBase.GetCurrentMethod().Name + "\n" + string.Format(" LINE : {0} 행\n", (object) new StackFrame(0, true).GetFileLineNumber()) + "--------------------------------------------------------------------------------------------------\n" + string.Format(" 에러 : {0}\n", (object) rs.LastErrorID) + " 내용 : " + rs.LastErrorMessage + "\n--------------------------------------------------------------------------------------------------\n");
          return (IList<StatementMonthHorizontalBySupplierCatMid>) null;
        }
        IList<StatementMonthHorizontalBySupplierCatMid> lt_list = (IList<StatementMonthHorizontalBySupplierCatMid>) new List<StatementMonthHorizontalBySupplierCatMid>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            StatementMonthHorizontalBySupplierCatMid bySupplierCatMid2 = bySupplierCatMid1.OleDB.Create<StatementMonthHorizontalBySupplierCatMid>();
            if (bySupplierCatMid2.GetFieldValues(rs))
            {
              bySupplierCatMid2.row_number = lt_list.Count + 1;
              lt_list.Add(bySupplierCatMid2);
            }
          }
    ...
    public async IAsyncEnumerable<StatementMonthHorizontalBySupplierCatMid> SelectMonthHorizontalBySupplierCatMidEnumerableAsync(
      object p_param)
    {
      StatementMonthHorizontalBySupplierCatMid bySupplierCatMid1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;
      ...
      try
      {
        ...
        else if (await rs.IsDataReadAsync())
        {
          ...
          do
          {
            ...
            if (bySupplierCatMid2.GetFieldValues(rs))
            {
              bySupplierCatMid2.row_number = ++row_number;
              yield return bySupplierCatMid2;
            }
          }
          while (await rs.IsDataReadAsync());
        }

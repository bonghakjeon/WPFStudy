...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Month.Horizontal.SalesByMonthHorizontalByCategoryBot
...
{
  public class SalesByMonthHorizontalByCategoryBot : 
    SalesByMonthHorizontalByCategoryMid<SalesByMonthHorizontalByCategoryBot>
  {
    private string _ctg_ViewCode;
    private string _ctg_CategoryName;

    public override string KeyCode => string.Format("{0}", (object) this.si_StoreCode) + string.Format("|{0}|{1}|{2}", (object) this.dpt_lv1_ID, (object) this.dpt_lv2_ID, (object) this.sbd_DeptCode) + string.Format("|{0}|{1}|{2}", (object) this.ctg_lv1_ID, (object) this.ctg_lv2_ID, (object) this.sbd_CategoryCode);

    public override int sbd_CategoryCode
    {
    ...
    public void PutInfo(SalesByMonthHorizontalByCategoryBot pSource)
    {
      this.PutInfo((SalesByMonthHorizontalByCategoryMid) pSource);
    ...
    public void InitInfo(SalesByMonthHorizontalByCategoryBot pData, IList<DateTime> p_Days)
    {
      if (!this.KeyCode.Equals(pData.KeyCode))
        throw new Exception("pData 의 [sbd_StoreCode|dpt_lv1_ID|dpt_lv2_ID|sbd_DeptCode|ctg_lv1_ID|ctg_lv2_ID|sbd_CategoryCode] 이 KeyCode 와 다릅니다");
      this.PutInfo(pData);
      foreach (DateTime pDay in (IEnumerable<DateTime>) p_Days)
      {
        ...
        salesByMonthGoal.sbd_CategoryCode = this.sbd_CategoryCode;
        ltDetails.Add((SalesByDayGoal) salesByMonthGoal);
      }
    }

    public void Add(SalesByMonthHorizontalByCategoryBot item)
    {
      if (this.si_StoreCode == 0)
      {
        ...
        throw new Exception("item 의 [sbd_StoreCode|dpt_lv1_ID|dpt_lv2_ID|sbd_DeptCode|ctg_lv1_ID|ctg_lv2_ID|sbd_CategoryCode] 이 KeyCode 와 다릅니다");
    ...
    public void AddRange(IList<SalesByMonthHorizontalByCategoryBot> infos)
    {
      foreach (SalesByMonthHorizontalByCategoryBot info in (IEnumerable<SalesByMonthHorizontalByCategoryBot>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, SalesByMonthHorizontalByCategoryBot pSource) => pSource == null || this.IsZero(pCheckType, (SalesByMonthHorizontalByCategoryMid) pSource);
    ...
    public async Task<IList<SalesByMonthHorizontalByCategoryBot>> SelectMonthHorizontalByCategoryBotListAsync(
      object p_param)
    {
      SalesByMonthHorizontalByCategoryBot horizontalByCategoryBot1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;
      UniOleDatabase db = (UniOleDatabase) null;
      try
      {
        db = new UniOleDatabase(horizontalByCategoryBot1.OleDB.ConnectionUrl);
        rs = new UniOleDbRecordset(db, horizontalByCategoryBot1.OleDB.CommandTimeout);
        if (!await rs.OpenAsync(horizontalByCategoryBot1.GetSelectQuery(p_param)))
        {
          horizontalByCategoryBot1.SetErrorInfo(rs.LastErrorID, "검색 오류 - SQL OPEN 실패\n--------------------------------------------------------------------------------------------------\n 테이블 : " + horizontalByCategoryBot1.TableCode.ToDescription() + "\n 메소드 : " + MethodBase.GetCurrentMethod().ReflectedType.Name + "==>" + MethodBase.GetCurrentMethod().Name + "\n" + string.Format(" LINE : {0} 행\n", (object) new StackFrame(0, true).GetFileLineNumber()) + "--------------------------------------------------------------------------------------------------\n" + string.Format(" 에러 : {0}\n", (object) rs.LastErrorID) + " 내용 : " + rs.LastErrorMessage + "\n--------------------------------------------------------------------------------------------------\n");
          return (IList<SalesByMonthHorizontalByCategoryBot>) null;
        }
        IList<SalesByMonthHorizontalByCategoryBot> lt_list = (IList<SalesByMonthHorizontalByCategoryBot>) new List<SalesByMonthHorizontalByCategoryBot>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            SalesByMonthHorizontalByCategoryBot horizontalByCategoryBot2 = horizontalByCategoryBot1.OleDB.Create<SalesByMonthHorizontalByCategoryBot>();
            if (horizontalByCategoryBot2.GetFieldValues(rs))
            {
              horizontalByCategoryBot2.row_number = lt_list.Count + 1;
              lt_list.Add(horizontalByCategoryBot2);
            }
          }
    ...
    public async IAsyncEnumerable<SalesByMonthHorizontalByCategoryBot> SelectMonthHorizontalByCategoryBotEnumerableAsync(
      object p_param)
    {
      SalesByMonthHorizontalByCategoryBot horizontalByCategoryBot1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;
      ...
      try
      {
        ...
        else if (await rs.IsDataReadAsync())
        {
          ...
          do
          {
            ...
            if (horizontalByCategoryBot2.GetFieldValues(rs))
            {
              horizontalByCategoryBot2.row_number = ++row_number;
              yield return horizontalByCategoryBot2;
            }
          }
          while (await rs.IsDataReadAsync());
        }

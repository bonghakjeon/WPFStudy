...
// Type: UniBiz.Bo.Models.UniStock.Statement.Month.Horizontal.Supplier.StatementMonthHorizontalBySupplier
...
{
  public class StatementMonthHorizontalBySupplier : 
    StatementMonthHorizontalByStore<StatementMonthHorizontalBySupplier>
  {
    ...
    public override string ToString() => string.Format("{0} [{1}:{2}] Count : {3}", (object) nameof (StatementMonthHorizontalBySupplier), (object) this.su_SupplierName, (object) this.sh_Supplier, (object) this.Lt_Details.Count);
    ...
    public void PutInfo(StatementMonthHorizontalBySupplier pSource)
    {
      this.PutInfo((StatementMonthHorizontalByStore) pSource);
    ...
    public void Add(StatementMonthHorizontalBySupplier item)
    {
    ...
    public void AddRange(IList<StatementMonthHorizontalBySupplier> infos)
    {
      foreach (StatementMonthHorizontalBySupplier info in (IEnumerable<StatementMonthHorizontalBySupplier>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, StatementMonthHorizontalBySupplier pSource) => pSource == null || this.IsZero(pCheckType, (StatementMonthHorizontalByStore) pSource);
    ...
    public async Task<IList<StatementMonthHorizontalBySupplier>> SelectMonthHorizontalBySupplierListAsync(
      object p_param)
    {
      StatementMonthHorizontalBySupplier horizontalBySupplier1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(horizontalBySupplier1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<StatementMonthHorizontalBySupplier>) null;
        }
        IList<StatementMonthHorizontalBySupplier> lt_list = (IList<StatementMonthHorizontalBySupplier>) new List<StatementMonthHorizontalBySupplier>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            StatementMonthHorizontalBySupplier horizontalBySupplier2 = horizontalBySupplier1.OleDB.Create<StatementMonthHorizontalBySupplier>();
    ...
    public async IAsyncEnumerable<StatementMonthHorizontalBySupplier> SelectMonthHorizontalBySupplierEnumerableAsync(
      object p_param)
    {
      StatementMonthHorizontalBySupplier horizontalBySupplier1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

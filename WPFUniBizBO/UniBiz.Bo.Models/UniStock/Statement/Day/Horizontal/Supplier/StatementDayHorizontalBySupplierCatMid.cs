...
// Type: UniBiz.Bo.Models.UniStock.Statement.Day.Horizontal.Supplier.StatementDayHorizontalBySupplierCatMid
...
{
  public class StatementDayHorizontalBySupplierCatMid : 
    StatementDayHorizontalBySupplierCatTop<StatementDayHorizontalBySupplierCatMid>
  {
    ...
    public override string ToString() => string.Format("{0} [{1}({2})][{3}>{4}] Count : {5}", (object) nameof (StatementDayHorizontalBySupplierCatMid), (object) this.su_SupplierName, (object) this.sh_Supplier, (object) this.ctg_lv1_Name, (object) this.ctg_lv2_Name, (object) this.Lt_Details.Count);
    ...
    public void PutInfo(StatementDayHorizontalBySupplierCatMid pSource)
    {
      this.PutInfo((StatementDayHorizontalBySupplierCatTop) pSource);
    ...
    public void Add(StatementDayHorizontalBySupplierCatMid item)
    {
    ...
    public void AddRange(
      IList<StatementDayHorizontalBySupplierCatMid> infos)
    {
      foreach (StatementDayHorizontalBySupplierCatMid info in (IEnumerable<StatementDayHorizontalBySupplierCatMid>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, StatementDayHorizontalBySupplierCatMid pSource) => pSource == null || this.IsZero(pCheckType, (StatementDayHorizontalBySupplierCatTop) pSource);
    ...
    public async Task<IList<StatementDayHorizontalBySupplierCatMid>> SelectDayHorizontalBySupplierCatMidListAsync(
      object p_param)
    {
      StatementDayHorizontalBySupplierCatMid bySupplierCatMid1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(bySupplierCatMid1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<StatementDayHorizontalBySupplierCatMid>) null;
        }
        IList<StatementDayHorizontalBySupplierCatMid> lt_list = (IList<StatementDayHorizontalBySupplierCatMid>) new List<StatementDayHorizontalBySupplierCatMid>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            StatementDayHorizontalBySupplierCatMid bySupplierCatMid2 = bySupplierCatMid1.OleDB.Create<StatementDayHorizontalBySupplierCatMid>();
    ...
    public async IAsyncEnumerable<StatementDayHorizontalBySupplierCatMid> SelectDayHorizontalBySupplierCatMidEnumerableAsync(
      object p_param)
    {
      StatementDayHorizontalBySupplierCatMid bySupplierCatMid1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

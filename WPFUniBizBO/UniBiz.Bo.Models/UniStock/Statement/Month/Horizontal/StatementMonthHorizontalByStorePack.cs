...
// Type: UniBiz.Bo.Models.UniStock.Statement.Month.Horizontal.StatementMonthHorizontalByStorePack
...
{
  public class StatementMonthHorizontalByStorePack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private StatementMonthHorizontalByStoreDic _DataBody;
    ...
    public StatementMonthHorizontalByStoreDic DataBody
    {
      get => this._DataBody;
      set
      {

...
// Type: UniBiz.Bo.Models.UniStock.Statement.Month.Horizontal.Supplier.StatementMonthHorizontalBySupplierPack
...
{
  public class StatementMonthHorizontalBySupplierPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private StatementMonthHorizontalBySupplierDic _DataBody;
    ...
    public StatementMonthHorizontalBySupplierDic DataBody
    {
      get => this._DataBody;
      set
      {

...
// Type: UniBiz.Bo.Models.UniStock.Statement.Month.Horizontal.Supplier.StatementMonthHorizontalBySupplierGoodsPack
...
{
  public class StatementMonthHorizontalBySupplierGoodsPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private StatementMonthHorizontalBySupplierGoodsDic _DataBody;
    ...
    public StatementMonthHorizontalBySupplierGoodsDic DataBody
    {
      get => this._DataBody;
      set
      {

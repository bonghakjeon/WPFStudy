...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Day.Horizontal.SalesByDayHorizontalByTeam
...
{
  public class SalesByDayHorizontalByTeam : SalesByDayHorizontalByStore<SalesByDayHorizontalByTeam>
  {
    ...
    public void PutInfo(SalesByDayHorizontalByTeam pSource)
    {
    ...
    public void Add(SalesByDayHorizontalByTeam item)
    {
    ...
    public void AddRange(IList<SalesByDayHorizontalByTeam> infos)
    {
      foreach (SalesByDayHorizontalByTeam info in (IEnumerable<SalesByDayHorizontalByTeam>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, SalesByDayHorizontalByTeam pSource) => pSource == null || this.IsZero(pCheckType, (SalesByDayHorizontalByStore) pSource);
    ...
    public async Task<IList<SalesByDayHorizontalByTeam>> SelectDayHorizontalByTeamListAsync(
      object p_param)
    {
      SalesByDayHorizontalByTeam horizontalByTeam1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(horizontalByTeam1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<SalesByDayHorizontalByTeam>) null;
        }
        IList<SalesByDayHorizontalByTeam> lt_list = (IList<SalesByDayHorizontalByTeam>) new List<SalesByDayHorizontalByTeam>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            SalesByDayHorizontalByTeam horizontalByTeam2 = horizontalByTeam1.OleDB.Create<SalesByDayHorizontalByTeam>();
    ...
    public async IAsyncEnumerable<SalesByDayHorizontalByTeam> SelectDayHorizontalByTeamEnumerableAsync(
      object p_param)
    {
      SalesByDayHorizontalByTeam horizontalByTeam1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

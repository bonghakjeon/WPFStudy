...
// Type: UniBiz.Bo.Models.UniStock.Statement.Day.Horizontal.StatementDayHorizontalByCategoryTop
...
{
  public class StatementDayHorizontalByCategoryTop : 
    StatementDayHorizontalByDept<StatementDayHorizontalByCategoryTop>
  {
    ...
    public override string ToString() => string.Format("{0} [{1}:{2}] Count : {3}", (object) nameof (StatementDayHorizontalByCategoryTop), (object) this.si_StoreName, (object) this.ctg_lv1_Name, (object) this.Lt_Details.Count);
    ...
    public void PutInfo(StatementDayHorizontalByCategoryTop pSource)
    {
      this.PutInfo((StatementDayHorizontalByDept) pSource);
    ...
    public void Add(StatementDayHorizontalByCategoryTop item)
    {
    ...
    public void AddRange(IList<StatementDayHorizontalByCategoryTop> infos)
    {
      foreach (StatementDayHorizontalByCategoryTop info in (IEnumerable<StatementDayHorizontalByCategoryTop>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, StatementDayHorizontalByCategoryTop pSource) => pSource == null || this.IsZero(pCheckType, (StatementDayHorizontalByDept) pSource);
    ...
    public async Task<IList<StatementDayHorizontalByCategoryTop>> SelectDayHorizontalByCategoryTopListAsync(
      object p_param)
    {
      StatementDayHorizontalByCategoryTop horizontalByCategoryTop1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(horizontalByCategoryTop1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<StatementDayHorizontalByCategoryTop>) null;
        }
        IList<StatementDayHorizontalByCategoryTop> lt_list = (IList<StatementDayHorizontalByCategoryTop>) new List<StatementDayHorizontalByCategoryTop>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            StatementDayHorizontalByCategoryTop horizontalByCategoryTop2 = horizontalByCategoryTop1.OleDB.Create<StatementDayHorizontalByCategoryTop>();
    ...
    public async IAsyncEnumerable<StatementDayHorizontalByCategoryTop> SelectDayHorizontalByCategoryTopEnumerableAsync(
      object p_param)
    {
      StatementDayHorizontalByCategoryTop horizontalByCategoryTop1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

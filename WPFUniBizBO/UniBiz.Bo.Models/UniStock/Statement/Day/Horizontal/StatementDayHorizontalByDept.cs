...
// Type: UniBiz.Bo.Models.UniStock.Statement.Day.Horizontal.StatementDayHorizontalByDept
...
{
  public class StatementDayHorizontalByDept : 
    StatementDayHorizontalByTeam<StatementDayHorizontalByDept>
  {
    private int _dpt_ID;
    ...
    public override string ToString() => string.Format("{0} [{1}:{2}>{3}>{4}] Count : {5}", (object) nameof (StatementDayHorizontalByDept), (object) this.si_StoreName, (object) this.dpt_lv1_Name, (object) this.dpt_lv2_Name, (object) this.dpt_lv3_Name, (object) this.Lt_Details.Count);
    ...
    public void PutInfo(StatementDayHorizontalByDept pSource)
    {
      this.PutInfo((StatementDayHorizontalByTeam) pSource);
    ...
    public void Add(StatementDayHorizontalByDept item)
    {
    ...
    public void AddRange(IList<StatementDayHorizontalByDept> infos)
    {
      foreach (StatementDayHorizontalByDept info in (IEnumerable<StatementDayHorizontalByDept>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, StatementDayHorizontalByDept pSource) => pSource == null || this.IsZero(pCheckType, (StatementDayHorizontalByTeam) pSource);
    ...
    public async Task<IList<StatementDayHorizontalByDept>> SelectDayHorizontalByDeptListAsync(
      object p_param)
    {
      StatementDayHorizontalByDept horizontalByDept1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(horizontalByDept1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<StatementDayHorizontalByDept>) null;
        }
        IList<StatementDayHorizontalByDept> lt_list = (IList<StatementDayHorizontalByDept>) new List<StatementDayHorizontalByDept>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            StatementDayHorizontalByDept horizontalByDept2 = horizontalByDept1.OleDB.Create<StatementDayHorizontalByDept>();
    ...
    public async IAsyncEnumerable<StatementDayHorizontalByDept> SelectDayHorizontalByDeptEnumerableAsync(
      object p_param)
    {
      StatementDayHorizontalByDept horizontalByDept1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

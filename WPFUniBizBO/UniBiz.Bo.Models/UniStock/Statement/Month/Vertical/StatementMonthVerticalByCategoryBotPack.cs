...
// Type: UniBiz.Bo.Models.UniStock.Statement.Month.Vertical.StatementMonthVerticalByCategoryBotPack
...
{
  public class StatementMonthVerticalByCategoryBotPack : BindableBase
  {
    private IList<CategoryView> _DataHeader;
    private StatementMonthVerticalByCategoryBotDic _DataBody;
    ...
    public StatementMonthVerticalByCategoryBotDic DataBody
    {
      get => this._DataBody;
      set
      {

...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Day.Horizontal.Supplier.SalesByDayHorizontalBySupplierGoodsPack
...
{
  public class SalesByDayHorizontalBySupplierGoodsPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private SalesByDayHorizontalBySupplierGoodsDic _DataBody;
    ...
    public SalesByDayHorizontalBySupplierGoodsDic DataBody
    {
      get => this._DataBody;
      set
      {

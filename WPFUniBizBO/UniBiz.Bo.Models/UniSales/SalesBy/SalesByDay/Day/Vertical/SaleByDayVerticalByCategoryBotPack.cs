...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Day.Vertical.SaleByDayVerticalByCategoryBotPack
...
{
  public class SaleByDayVerticalByCategoryBotPack : BindableBase
  {
    private IList<CategoryView> _DataHeader;
    private SaleByDayVerticalByCategoryBotDic _DataBody;
    ...
    public SaleByDayVerticalByCategoryBotDic DataBody
    {
      get => this._DataBody;
      set
      {

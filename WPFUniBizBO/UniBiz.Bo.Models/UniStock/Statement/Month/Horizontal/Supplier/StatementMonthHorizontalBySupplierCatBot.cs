...
// Type: UniBiz.Bo.Models.UniStock.Statement.Month.Horizontal.Supplier.StatementMonthHorizontalBySupplierCatBot
...
{
  public class StatementMonthHorizontalBySupplierCatBot : 
    StatementMonthHorizontalBySupplierCatMid<StatementMonthHorizontalBySupplierCatBot>
  {
    ...
    public override string ToString() => string.Format("{0} [{1}({2})][{3}>{4}>{5}] Count : {6}", (object) nameof (StatementMonthHorizontalBySupplierCatBot), (object) this.su_SupplierName, (object) this.sh_Supplier, (object) this.ctg_lv1_Name, (object) this.ctg_lv2_Name, (object) this.ctg_CategoryName, (object) this.Lt_Details.Count);
    ...
    public void PutInfo(StatementMonthHorizontalBySupplierCatBot pSource)
    {
      this.PutInfo((StatementMonthHorizontalBySupplierCatMid) pSource);
    ...
    public void Add(StatementMonthHorizontalBySupplierCatBot item)
    {
    ...
    public void AddRange(
      IList<StatementMonthHorizontalBySupplierCatBot> infos)
    {
      foreach (StatementMonthHorizontalBySupplierCatBot info in (IEnumerable<StatementMonthHorizontalBySupplierCatBot>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, StatementMonthHorizontalBySupplierCatBot pSource) => pSource == null || this.IsZero(pCheckType, (StatementMonthHorizontalBySupplierCatMid) pSource);
    ...
    public async Task<IList<StatementMonthHorizontalBySupplierCatBot>> SelectMonthHorizontalBySupplierCatBotListAsync(
      object p_param)
    {
      StatementMonthHorizontalBySupplierCatBot bySupplierCatBot1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(bySupplierCatBot1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<StatementMonthHorizontalBySupplierCatBot>) null;
        }
        IList<StatementMonthHorizontalBySupplierCatBot> lt_list = (IList<StatementMonthHorizontalBySupplierCatBot>) new List<StatementMonthHorizontalBySupplierCatBot>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            StatementMonthHorizontalBySupplierCatBot bySupplierCatBot2 = bySupplierCatBot1.OleDB.Create<StatementMonthHorizontalBySupplierCatBot>();
    ...
    public async IAsyncEnumerable<StatementMonthHorizontalBySupplierCatBot> SelectMonthHorizontalBySupplierCatBotEnumerableAsync(
      object p_param)
    {
      StatementMonthHorizontalBySupplierCatBot bySupplierCatBot1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

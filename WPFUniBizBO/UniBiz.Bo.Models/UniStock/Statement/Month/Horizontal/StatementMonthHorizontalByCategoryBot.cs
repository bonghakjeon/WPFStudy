...
// Type: UniBiz.Bo.Models.UniStock.Statement.Month.Horizontal.StatementMonthHorizontalByCategoryBot
...
{
  public class StatementMonthHorizontalByCategoryBot : 
    StatementMonthHorizontalByCategoryMid<StatementMonthHorizontalByCategoryBot>
  {
    private string _ctg_ViewCode;
    private string _ctg_CategoryName;

    public override string KeyCode => string.Format("{0}", (object) this.sh_StoreCode) + string.Format("|{0}|{1}|{2}", (object) this.dpt_lv1_ID, (object) this.dpt_lv2_ID, (object) this.dpt_ID) + string.Format("|{0}|{1}|{2}", (object) this.ctg_lv1_ID, (object) this.ctg_lv2_ID, (object) this.sd_CategoryCode);
    ...
    public override string ToString() => string.Format("{0} [{1}:{2}>{3}>{4}] Count : {5}", (object) nameof (StatementMonthHorizontalByCategoryBot), (object) this.si_StoreName, (object) this.ctg_lv1_Name, (object) this.ctg_lv2_Name, (object) this.ctg_lv3_Name, (object) this.Lt_Details.Count);
    ...
    public void PutInfo(StatementMonthHorizontalByCategoryBot pSource)
    {
      this.PutInfo((StatementMonthHorizontalByCategoryMid) pSource);
    ...
    public void InitInfo(StatementMonthHorizontalByCategoryBot pData, IList<DateTime> p_Days)
    {
      if (!this.KeyCode.Equals(pData.KeyCode))
        throw new Exception("pData 의 [sh_StoreCode|dpt_lv1_ID|dpt_lv2_ID|dpt_ID|ctg_lv1_ID|ctg_lv2_ID|sd_CategoryCode] 이 KeyCode 와 다릅니다");
      this.PutInfo(pData);
    ...
    public void Add(StatementMonthHorizontalByCategoryBot item)
    {
      ...
      else
      {
        ...
        if (!this.KeyCode.Equals(item.KeyCode))
          throw new Exception("item 의 [sh_StoreCode|dpt_lv1_ID|dpt_lv2_ID|dpt_ID|ctg_lv1_ID|ctg_lv2_ID|sd_CategoryCode] 이 KeyCode 와 다릅니다");
      }
    ...
    public void AddRange(IList<StatementMonthHorizontalByCategoryBot> infos)
    {
      foreach (StatementMonthHorizontalByCategoryBot info in (IEnumerable<StatementMonthHorizontalByCategoryBot>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, StatementMonthHorizontalByCategoryBot pSource) => pSource == null || this.IsZero(pCheckType, (StatementMonthHorizontalByCategoryMid) pSource);
    ...
    public async Task<IList<StatementMonthHorizontalByCategoryBot>> SelectMonthHorizontalByCategoryBotListAsync(
      object p_param)
    {
      StatementMonthHorizontalByCategoryBot horizontalByCategoryBot1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(horizontalByCategoryBot1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<StatementMonthHorizontalByCategoryBot>) null;
        }
        IList<StatementMonthHorizontalByCategoryBot> lt_list = (IList<StatementMonthHorizontalByCategoryBot>) new List<StatementMonthHorizontalByCategoryBot>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            StatementMonthHorizontalByCategoryBot horizontalByCategoryBot2 = horizontalByCategoryBot1.OleDB.Create<StatementMonthHorizontalByCategoryBot>();
    ...
    public async IAsyncEnumerable<StatementMonthHorizontalByCategoryBot> SelectMonthHorizontalByCategoryBotEnumerableAsync(
      object p_param)
    {
      StatementMonthHorizontalByCategoryBot horizontalByCategoryBot1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

...
// Type: UniBiz.Bo.Models.UniStock.Statement.Month.Horizontal.StatementMonthHorizontalByTeam
...
{
  public class StatementMonthHorizontalByTeam : 
    StatementMonthHorizontalByStore<StatementMonthHorizontalByTeam>
  {
    ...
    public override string ToString() => string.Format("{0} [{1}:{2}>{3}] Count : {4}", (object) nameof (StatementMonthHorizontalByTeam), (object) this.si_StoreName, (object) this.dpt_lv1_Name, (object) this.dpt_lv2_Name, (object) this.Lt_Details.Count);
    ...
    public void PutInfo(StatementMonthHorizontalByTeam pSource)
    {
    ...
    public void Add(StatementMonthHorizontalByTeam item)
    {
    ...
    public void AddRange(IList<StatementMonthHorizontalByTeam> infos)
    {
      foreach (StatementMonthHorizontalByTeam info in (IEnumerable<StatementMonthHorizontalByTeam>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, StatementMonthHorizontalByTeam pSource) => pSource == null || this.IsZero(pCheckType, (StatementMonthHorizontalByStore) pSource);
    ...
    public async Task<IList<StatementMonthHorizontalByTeam>> SelectMonthHorizontalByTeamListAsync(
      object p_param)
    {
      StatementMonthHorizontalByTeam horizontalByTeam1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(horizontalByTeam1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<StatementMonthHorizontalByTeam>) null;
        }
        IList<StatementMonthHorizontalByTeam> lt_list = (IList<StatementMonthHorizontalByTeam>) new List<StatementMonthHorizontalByTeam>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            StatementMonthHorizontalByTeam horizontalByTeam2 = horizontalByTeam1.OleDB.Create<StatementMonthHorizontalByTeam>();
    ...
    public async IAsyncEnumerable<StatementMonthHorizontalByTeam> SelectMonthHorizontalByTeamEnumerableAsync(
      object p_param)
    {
      StatementMonthHorizontalByTeam horizontalByTeam1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

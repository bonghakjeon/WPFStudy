...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Supplier.SaleByDayDateSupplierCategoryMidBefore
...
{
  public class SaleByDayDateSupplierCategoryMidBefore : 
    SaleByDayDateSupplierCategoryTopBefore<SaleByDayDateSupplierCategoryMidBefore>
  {
    ...
    protected override UbModelBase CreateClone => (UbModelBase) new SaleByDayDateSupplierCategoryMidBefore();

    public override object Clone()
    {
      SaleByDayDateSupplierCategoryMidBefore categoryMidBefore = base.Clone() as SaleByDayDateSupplierCategoryMidBefore;
    ...
    public void PutData(SaleByDayDateSupplierCategoryMidBefore pSource)
    {
      this.PutData((SaleByDayDateSupplierCategoryTopBefore) pSource);
      this.ctg_lv2_ID = pSource.ctg_lv2_ID;
      this.ctg_lv2_ViewCode = pSource.ctg_lv2_ViewCode;
      this.ctg_lv2_Name = pSource.ctg_lv2_Name;
    }

    public bool IsZero(EnumZeroCheck pCheckType, SaleByDayDateSupplierCategoryMidBefore pSource) => pSource == null || this.IsZero(pCheckType, (SaleByDayDateSupplierCategoryTopBefore) pSource);
    ...
    public async Task<IList<SaleByDayDateSupplierCategoryMidBefore>> SelectDateSupplierCategoryMidBeforeListAsync(
      object p_param)
    {
      SaleByDayDateSupplierCategoryMidBefore categoryMidBefore1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(categoryMidBefore1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<SaleByDayDateSupplierCategoryMidBefore>) null;
        }
        IList<SaleByDayDateSupplierCategoryMidBefore> lt_list = (IList<SaleByDayDateSupplierCategoryMidBefore>) new List<SaleByDayDateSupplierCategoryMidBefore>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            SaleByDayDateSupplierCategoryMidBefore categoryMidBefore2 = categoryMidBefore1.OleDB.Create<SaleByDayDateSupplierCategoryMidBefore>();
    ...
    public async IAsyncEnumerable<SaleByDayDateSupplierCategoryMidBefore> SelectDateSupplierCategoryMidBeforeEnumerableAsync(
      object p_param)
    {
      SaleByDayDateSupplierCategoryMidBefore categoryMidBefore1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

...
// Type: UniBiz.Bo.Models.UniStock.Statement.Day.Horizontal.StatementDayHorizontalByStorePack
...
{
  public class StatementDayHorizontalByStorePack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private StatementDayHorizontalByStoreDic _DataBody;
    ...
    public StatementDayHorizontalByStoreDic DataBody
    {
      get => this._DataBody;
      set
      {

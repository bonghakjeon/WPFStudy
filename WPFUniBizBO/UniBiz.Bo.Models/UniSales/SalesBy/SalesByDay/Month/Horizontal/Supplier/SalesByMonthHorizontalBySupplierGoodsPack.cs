...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Month.Horizontal.Supplier.SalesByMonthHorizontalBySupplierGoodsPack
...
{
  public class SalesByMonthHorizontalBySupplierGoodsPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private SalesByMonthHorizontalBySupplierGoodsDic _DataBody;
    ...
    public SalesByMonthHorizontalBySupplierGoodsDic DataBody
    {
      get => this._DataBody;
      set
      {

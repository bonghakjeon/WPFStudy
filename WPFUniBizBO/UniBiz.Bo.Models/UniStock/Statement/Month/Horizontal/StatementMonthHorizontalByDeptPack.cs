...
// Type: UniBiz.Bo.Models.UniStock.Statement.Month.Horizontal.StatementMonthHorizontalByDeptPack
...
{
  public class StatementMonthHorizontalByDeptPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private StatementMonthHorizontalByDeptDic _DataBody;
    ...
    public StatementMonthHorizontalByDeptDic DataBody
    {
      get => this._DataBody;
      set
      {

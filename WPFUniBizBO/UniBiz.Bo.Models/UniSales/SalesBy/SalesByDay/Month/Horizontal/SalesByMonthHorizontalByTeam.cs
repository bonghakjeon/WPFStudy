...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Month.Horizontal.SalesByMonthHorizontalByTeam
...
{
  public class SalesByMonthHorizontalByTeam : 
    SalesByMonthHorizontalByStore<SalesByMonthHorizontalByTeam>
  {
    ...
    public override string KeyCode => string.Format("{0}|{1}|{2}", (object) this.si_StoreCode, (object) this.dpt_lv1_ID, (object) this.dpt_lv2_ID);
    ...
    public void PutInfo(SalesByMonthHorizontalByTeam pSource)
    {
    ...
    public void InitInfo(SalesByMonthHorizontalByTeam pData, IList<DateTime> p_Days)
    {
      if (!this.KeyCode.Equals(pData.KeyCode))
        throw new Exception("pData 의 [sbd_StoreCode|dpt_lv1_ID|dpt_lv2_ID] 이 KeyCode 와 다릅니다");
      this.PutInfo(pData);
    ...
    public void Add(SalesByMonthHorizontalByTeam item)
    {
      if (this.si_StoreCode == 0)
      {
        ...
        throw new Exception("item 의 [sbd_StoreCode|dpt_lv1_ID|dpt_lv2_ID] 이 KeyCode 와 다릅니다");
    ...
    public void AddRange(IList<SalesByMonthHorizontalByTeam> infos)
    {
      foreach (SalesByMonthHorizontalByTeam info in (IEnumerable<SalesByMonthHorizontalByTeam>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, SalesByMonthHorizontalByTeam pSource) => pSource == null || this.IsZero(pCheckType, (SalesByMonthHorizontalByStore) pSource);
    ...
    public async Task<IList<SalesByMonthHorizontalByTeam>> SelectMonthHorizontalByTeamListAsync(
      object p_param)
    {
      SalesByMonthHorizontalByTeam horizontalByTeam1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(horizontalByTeam1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<SalesByMonthHorizontalByTeam>) null;
        }
        IList<SalesByMonthHorizontalByTeam> lt_list = (IList<SalesByMonthHorizontalByTeam>) new List<SalesByMonthHorizontalByTeam>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            SalesByMonthHorizontalByTeam horizontalByTeam2 = horizontalByTeam1.OleDB.Create<SalesByMonthHorizontalByTeam>();
    ...
    public async IAsyncEnumerable<SalesByMonthHorizontalByTeam> SelectMonthHorizontalByTeamEnumerableAsync(
      object p_param)
    {
      SalesByMonthHorizontalByTeam horizontalByTeam1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

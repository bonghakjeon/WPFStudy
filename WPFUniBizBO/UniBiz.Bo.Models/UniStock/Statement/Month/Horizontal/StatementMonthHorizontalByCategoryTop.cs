...
// Type: UniBiz.Bo.Models.UniStock.Statement.Month.Horizontal.StatementMonthHorizontalByCategoryTop
...
{
  public class StatementMonthHorizontalByCategoryTop : 
    StatementMonthHorizontalByDept<StatementMonthHorizontalByCategoryTop>
  {
    private int _ctg_lv1_ID;
    private string _ctg_lv1_ViewCode;
    private string _ctg_lv1_Name;

    public override string KeyCode => string.Format("{0}|{1}|{2}|{3}|{4}", (object) this.sh_StoreCode, (object) this.dpt_lv1_ID, (object) this.dpt_lv2_ID, (object) this.dpt_ID, (object) this.ctg_lv1_ID);
    ...
    public override string ToString() => string.Format("{0} [{1}:{2}] Count : {3}", (object) nameof (StatementMonthHorizontalByCategoryTop), (object) this.si_StoreName, (object) this.ctg_lv1_Name, (object) this.Lt_Details.Count);
    ...
    public void PutInfo(StatementMonthHorizontalByCategoryTop pSource)
    {
      this.PutInfo((StatementMonthHorizontalByDept) pSource);
    ...
    public void InitInfo(StatementMonthHorizontalByCategoryTop pData, IList<DateTime> p_Days)
    {
      if (!this.KeyCode.Equals(pData.KeyCode))
        throw new Exception("pData 의 [sh_StoreCode|dpt_lv1_ID|dpt_lv2_ID|dpt_ID|ctg_lv1_ID] 이 KeyCode 와 다릅니다");
      this.PutInfo(pData);
    ...
    public void Add(StatementMonthHorizontalByCategoryTop item)
    {
      ...
      else
      {
        ...
        if (!this.KeyCode.Equals(item.KeyCode))
          throw new Exception("item 의 [sh_StoreCode|dpt_lv1_ID|dpt_lv2_ID|dpt_ID|ctg_lv1_ID] 이 KeyCode 와 다릅니다");
      }
    ...
    public void AddRange(IList<StatementMonthHorizontalByCategoryTop> infos)
    {
      foreach (StatementMonthHorizontalByCategoryTop info in (IEnumerable<StatementMonthHorizontalByCategoryTop>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, StatementMonthHorizontalByCategoryTop pSource) => pSource == null || this.IsZero(pCheckType, (StatementMonthHorizontalByDept) pSource);
    ...
    public async Task<IList<StatementMonthHorizontalByCategoryTop>> SelectMonthHorizontalByCategoryTopListAsync(
      object p_param)
    {
      StatementMonthHorizontalByCategoryTop horizontalByCategoryTop1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(horizontalByCategoryTop1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<StatementMonthHorizontalByCategoryTop>) null;
        }
        IList<StatementMonthHorizontalByCategoryTop> lt_list = (IList<StatementMonthHorizontalByCategoryTop>) new List<StatementMonthHorizontalByCategoryTop>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            StatementMonthHorizontalByCategoryTop horizontalByCategoryTop2 = horizontalByCategoryTop1.OleDB.Create<StatementMonthHorizontalByCategoryTop>();
    ...
    public async IAsyncEnumerable<StatementMonthHorizontalByCategoryTop> SelectMonthHorizontalByCategoryTopEnumerableAsync(
      object p_param)
    {
      StatementMonthHorizontalByCategoryTop horizontalByCategoryTop1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

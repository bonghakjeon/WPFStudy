...
// Type: UniBiz.Bo.Models.UniStock.Statement.Day.Horizontal.Supplier.StatementDayHorizontalBySupplierCatBotPack
...
{
  public class StatementDayHorizontalBySupplierCatBotPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private StatementDayHorizontalBySupplierCatBotDic _DataBody;
    ...
    public StatementDayHorizontalBySupplierCatBotDic DataBody
    {
      get => this._DataBody;
      set
      {

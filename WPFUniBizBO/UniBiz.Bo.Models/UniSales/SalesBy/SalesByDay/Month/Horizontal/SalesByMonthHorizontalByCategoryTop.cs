...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Month.Horizontal.SalesByMonthHorizontalByCategoryTop
...
{
  public class SalesByMonthHorizontalByCategoryTop : 
    SalesByMonthHorizontalByDept<SalesByMonthHorizontalByCategoryTop>
  {
    ...
    public void PutInfo(SalesByMonthHorizontalByCategoryTop pSource)
    {
      this.PutInfo((SalesByMonthHorizontalByDept) pSource);
    ...
    public void Add(SalesByMonthHorizontalByCategoryTop item)
    {
    ...
    public void AddRange(IList<SalesByMonthHorizontalByCategoryTop> infos)
    {
      foreach (SalesByMonthHorizontalByCategoryTop info in (IEnumerable<SalesByMonthHorizontalByCategoryTop>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, SalesByMonthHorizontalByCategoryTop pSource) => pSource == null || this.IsZero(pCheckType, (SalesByMonthHorizontalByDept) pSource);
    ...
    public async Task<IList<SalesByMonthHorizontalByCategoryTop>> SelectMonthHorizontalByCategoryTopListAsync(
      object p_param)
    {
      SalesByMonthHorizontalByCategoryTop horizontalByCategoryTop1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(horizontalByCategoryTop1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<SalesByMonthHorizontalByCategoryTop>) null;
        }
        IList<SalesByMonthHorizontalByCategoryTop> lt_list = (IList<SalesByMonthHorizontalByCategoryTop>) new List<SalesByMonthHorizontalByCategoryTop>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            SalesByMonthHorizontalByCategoryTop horizontalByCategoryTop2 = horizontalByCategoryTop1.OleDB.Create<SalesByMonthHorizontalByCategoryTop>();
    ...
    public async IAsyncEnumerable<SalesByMonthHorizontalByCategoryTop> SelectMonthHorizontalByCategoryTopEnumerableAsync(
      object p_param)
    {
      SalesByMonthHorizontalByCategoryTop horizontalByCategoryTop1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;
    ...
    public override string GetSelectQuery(object p_param)
    {
      ...
      try
      {
        ...
        if (flag)
        {
          ...
          stringBuilder.Append(" " + "gbc_SaleDate".DateToStr(EnumDbDateType.YYYYMM) + " AS sbd_SaleMonth");
          stringBuilder.Append(",");
          if (p_isStoreTotal)
            stringBuilder.Append(" 1 AS");
          else
          ...
          stringBuilder.Append("\n GROUP BY " + "gbc_SaleDate".DateToStr(EnumDbDateType.YYYYMM));
          if (!p_isStoreTotal)

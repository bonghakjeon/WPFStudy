...
// Type: UniBiz.Bo.Models.UniStock.Statement.Day.Vertical.StatementDayVerticalByCategoryBotPack
...
{
  public class StatementDayVerticalByCategoryBotPack : BindableBase
  {
    private IList<CategoryView> _DataHeader;
    private StatementDayVerticalByCategoryBotDic _DataBody;
    ...
    public StatementDayVerticalByCategoryBotDic DataBody
    {
      get => this._DataBody;
      set
      {

...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Month.Horizontal.SalesByMonthHorizontalByTeamPack
...
{
  public class SalesByMonthHorizontalByTeamPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private SalesByMonthHorizontalByTeamDic _DataBody;
    ...
    public SalesByMonthHorizontalByTeamDic DataBody
    {
      get => this._DataBody;
      set
      {

...
// Type: UniBiz.Bo.Models.UniStock.Inventory.InventorySummary.Date.InventorySummaryDateCategoryMid
...
{
  public class InventorySummaryDateCategoryMid : 
    InventorySummaryDateCategoryTop<InventorySummaryDateCategoryMid>
  {
    ...
    protected override UbModelBase CreateClone => (UbModelBase) new InventorySummaryDateCategoryMid();

    public override object Clone()
    {
      InventorySummaryDateCategoryMid summaryDateCategoryMid = base.Clone() as InventorySummaryDateCategoryMid;
    ...
    public void PutData(InventorySummaryDateCategoryMid pSource)
    {
      this.PutData((InventorySummaryDateCategoryTop) pSource);
      this.ctg_lv2_ID = pSource.ctg_lv2_ID;
      this.ctg_lv2_ViewCode = pSource.ctg_lv2_ViewCode;
      this.ctg_lv2_Name = pSource.ctg_lv2_Name;
    }

    public bool IsZero(EnumZeroCheck pCheckType, InventorySummaryDateCategoryMid pSource) => pSource == null || this.IsZero(pCheckType, (InventorySummaryDateCategoryTop) pSource);
    ...
    public async Task<IList<InventorySummaryDateCategoryMid>> SelectDateCategoryMidListAsync(
      object p_param)
    {
      InventorySummaryDateCategoryMid summaryDateCategoryMid1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(summaryDateCategoryMid1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<InventorySummaryDateCategoryMid>) null;
        }
        IList<InventorySummaryDateCategoryMid> lt_list = (IList<InventorySummaryDateCategoryMid>) new List<InventorySummaryDateCategoryMid>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            InventorySummaryDateCategoryMid summaryDateCategoryMid2 = summaryDateCategoryMid1.OleDB.Create<InventorySummaryDateCategoryMid>();
    ...
    public async IAsyncEnumerable<InventorySummaryDateCategoryMid> SelectDateCategoryMidEnumerableAsync(
      object p_param)
    {
      InventorySummaryDateCategoryMid summaryDateCategoryMid1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

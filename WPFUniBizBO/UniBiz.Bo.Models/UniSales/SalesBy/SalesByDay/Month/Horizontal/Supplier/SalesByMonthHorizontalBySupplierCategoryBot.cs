...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Month.Horizontal.Supplier.SalesByMonthHorizontalBySupplierCategoryBot
...
{
  public class SalesByMonthHorizontalBySupplierCategoryBot : 
    SalesByMonthHorizontalBySupplierCategoryMid<SalesByMonthHorizontalBySupplierCategoryBot>
  {
    private string _ctg_ViewCode;
    private string _ctg_CategoryName;

    public override string KeyCode => string.Format("{0}|{1}|{2}|{3}|{4}", (object) this.si_StoreCode, (object) this.sbd_Supplier, (object) this.ctg_lv1_ID, (object) this.ctg_lv2_ID, (object) this.sbd_CategoryCode);
    ...
    public override string ToString() => string.Format("{0} [{1}({2})][{3}>{4}>{5}] Count : {6}", (object) nameof (SalesByMonthHorizontalBySupplierCategoryBot), (object) this.su_SupplierName, (object) this.sbd_Supplier, (object) this.ctg_lv1_Name, (object) this.ctg_lv2_Name, (object) this.ctg_CategoryName, (object) this.Lt_Details.Count);
    ...
    public void PutInfo(
      SalesByMonthHorizontalBySupplierCategoryBot pSource)
    {
      this.PutInfo((SalesByMonthHorizontalBySupplierCategoryMid) pSource);
    ...
    public void InitInfo(SalesByMonthHorizontalBySupplierCategoryBot pData, IList<DateTime> p_Days)
    {
      if (!this.KeyCode.Equals(pData.KeyCode))
        throw new Exception("pData 의 [sbd_StoreCode|sbd_Supplier|ctg_lv1_ID|ctg_lv2_ID|sbd_CategoryCode] 이 KeyCode 와 다릅니다");
      this.PutInfo(pData);
    ...
    public void Add(SalesByMonthHorizontalBySupplierCategoryBot item)
    {
      if (this.si_StoreCode == 0)
      {
        ...
        throw new Exception("item 의 [sbd_StoreCode|sbd_Supplier|ctg_lv1_ID|ctg_lv2_ID|sbd_CategoryCode] 이 KeyCode 와 다릅니다");
    ...
    public void AddRange(
      IList<SalesByMonthHorizontalBySupplierCategoryBot> infos)
    {
      foreach (SalesByMonthHorizontalBySupplierCategoryBot info in (IEnumerable<SalesByMonthHorizontalBySupplierCategoryBot>) infos)
        this.Add(info);
    }
    ...
    public bool IsZero(
      ...
      SalesByMonthHorizontalBySupplierCategoryBot pSource)
    {
      return pSource == null || this.IsZero(pCheckType, (SalesByMonthHorizontalBySupplierCategoryMid) pSource);
    }
    ...
    public async Task<IList<SalesByMonthHorizontalBySupplierCategoryBot>> SelectMonthHorizontalBySupplierCategoryBotListAsync(
      object p_param)
    {
      SalesByMonthHorizontalBySupplierCategoryBot supplierCategoryBot1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(supplierCategoryBot1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<SalesByMonthHorizontalBySupplierCategoryBot>) null;
        }
        IList<SalesByMonthHorizontalBySupplierCategoryBot> lt_list = (IList<SalesByMonthHorizontalBySupplierCategoryBot>) new List<SalesByMonthHorizontalBySupplierCategoryBot>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            SalesByMonthHorizontalBySupplierCategoryBot supplierCategoryBot2 = supplierCategoryBot1.OleDB.Create<SalesByMonthHorizontalBySupplierCategoryBot>();
    ...
    public async IAsyncEnumerable<SalesByMonthHorizontalBySupplierCategoryBot> SelectMonthHorizontalBySupplierCategoryBotEnumerableAsync(
      object p_param)
    {
      SalesByMonthHorizontalBySupplierCategoryBot supplierCategoryBot1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

...
// Type: UniBizBO.Services.WorkDataSet
...
namespace UniBizBO.Services
{
  public abstract class WorkDataSet : BindableBase
  {
    ...
    public INotifyPropertyChangedExtend Origin
    {
      ...
      protected set
      {
        if (!this.SetAndNotify<INotifyPropertyChangedExtend>(ref this.origin, value, nameof (Origin)))
          return;
    ...
    public INotifyPropertyChangedExtend Current
    {
      ...
      protected set
      {
        if (!this.SetAndNotify<INotifyPropertyChangedExtend>(ref this.current, value, nameof (Current)))
          return;
    ...
    protected virtual void OnOriginChanged() => this.OriginChanged(this);

    protected virtual void OnCurrentChanged() => this.CurrentChanged(this);

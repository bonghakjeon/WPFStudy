...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Day.Horizontal.SalesByDayHorizontalByCategoryTopPack
...
{
  public class SalesByDayHorizontalByCategoryTopPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private SalesByDayHorizontalByCategoryTopDic _DataBody;
    ...
    public SalesByDayHorizontalByCategoryTopDic DataBody
    {
      get => this._DataBody;
      set
      {

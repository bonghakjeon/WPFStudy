...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Month.Horizontal.SalesByMonthHorizontalByDeptPack
...
{
  public class SalesByMonthHorizontalByDeptPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private SalesByMonthHorizontalByDeptDic _DataBody;
    ...
    public SalesByMonthHorizontalByDeptDic DataBody
    {
      get => this._DataBody;
      set
      {

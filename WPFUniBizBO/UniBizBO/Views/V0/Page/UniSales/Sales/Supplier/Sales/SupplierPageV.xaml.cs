...
// Type: UniBizBO.Views.V0.Page.UniSales.Sales.Supplier.Sales.SupplierPageV
...
{
  public partial class SupplierPageV : UserControl, IComponentConnector
  {
    internal SupplierPageV root;
    ...
    public SupplierPageV() => this.InitializeComponent();
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/UniBizBO;component/views/v0/page/unisales/sales/supplier/sales/supplierpagev.xaml", UriKind.Relative));
    }
    ...
    void IComponentConnector.Connect(int connectionId, object target)
    {
      ...
      {
        case 1:
          this.root = (SupplierPageV) target;
          break;
        case 2:

...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Day.Vertical.SaleByDayVerticalByTeamPack
...
{
  public class SaleByDayVerticalByTeamPack : BindableBase
  {
    private IList<DeptView> _DataHeader;
    private SaleByDayVerticalByTeamDic _DataBody;
    ...
    public SaleByDayVerticalByTeamDic DataBody
    {
      get => this._DataBody;
      set
      {

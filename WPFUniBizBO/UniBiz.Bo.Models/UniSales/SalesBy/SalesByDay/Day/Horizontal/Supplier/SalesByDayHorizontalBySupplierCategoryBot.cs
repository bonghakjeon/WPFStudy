...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Day.Horizontal.Supplier.SalesByDayHorizontalBySupplierCategoryBot
...
{
  public class SalesByDayHorizontalBySupplierCategoryBot : 
    SalesByDayHorizontalBySupplierCategoryMid<SalesByDayHorizontalBySupplierCategoryBot>
  {
    ...
    public override string ToString() => string.Format("{0} [{1}({2})][{3}>{4}>{5}] Count : {6}", (object) nameof (SalesByDayHorizontalBySupplierCategoryBot), (object) this.su_SupplierName, (object) this.sbd_Supplier, (object) this.ctg_lv1_Name, (object) this.ctg_lv2_Name, (object) this.ctg_CategoryName, (object) this.Lt_Details.Count);
    ...
    public void PutInfo(SalesByDayHorizontalBySupplierCategoryBot pSource)
    {
      this.PutInfo((SalesByDayHorizontalBySupplierCategoryMid) pSource);
    ...
    public void Add(SalesByDayHorizontalBySupplierCategoryBot item)
    {
    ...
    public void AddRange(
      IList<SalesByDayHorizontalBySupplierCategoryBot> infos)
    {
      foreach (SalesByDayHorizontalBySupplierCategoryBot info in (IEnumerable<SalesByDayHorizontalBySupplierCategoryBot>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, SalesByDayHorizontalBySupplierCategoryBot pSource) => pSource == null || this.IsZero(pCheckType, (SalesByDayHorizontalBySupplierCategoryMid) pSource);
    ...
    public async Task<IList<SalesByDayHorizontalBySupplierCategoryBot>> SelectDayHorizontalBySupplierCategoryBotListAsync(
      object p_param)
    {
      SalesByDayHorizontalBySupplierCategoryBot supplierCategoryBot1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(supplierCategoryBot1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<SalesByDayHorizontalBySupplierCategoryBot>) null;
        }
        IList<SalesByDayHorizontalBySupplierCategoryBot> lt_list = (IList<SalesByDayHorizontalBySupplierCategoryBot>) new List<SalesByDayHorizontalBySupplierCategoryBot>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            SalesByDayHorizontalBySupplierCategoryBot supplierCategoryBot2 = supplierCategoryBot1.OleDB.Create<SalesByDayHorizontalBySupplierCategoryBot>();
    ...
    public async IAsyncEnumerable<SalesByDayHorizontalBySupplierCategoryBot> SelectDayHorizontalBySupplierCategoryBotEnumerableAsync(
      object p_param)
    {
      SalesByDayHorizontalBySupplierCategoryBot supplierCategoryBot1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

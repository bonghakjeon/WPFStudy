...
// Type: UniBiz.Bo.Models.UniStock.Statement.Day.Vertical.StatementDayVerticalByCategoryTopPack
...
{
  public class StatementDayVerticalByCategoryTopPack : BindableBase
  {
    private IList<CategoryView> _DataHeader;
    private StatementDayVerticalByCategoryTopDic _DataBody;
    ...
    public StatementDayVerticalByCategoryTopDic DataBody
    {
      get => this._DataBody;
      set
      {

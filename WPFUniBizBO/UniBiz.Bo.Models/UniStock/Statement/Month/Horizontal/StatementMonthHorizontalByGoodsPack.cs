...
// Type: UniBiz.Bo.Models.UniStock.Statement.Month.Horizontal.StatementMonthHorizontalByGoodsPack
...
{
  public class StatementMonthHorizontalByGoodsPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private StatementMonthHorizontalByGoodsDic _DataBody;
    ...
    public StatementMonthHorizontalByGoodsDic DataBody
    {
      get => this._DataBody;
      set
      {

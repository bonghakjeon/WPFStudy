...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Day.Horizontal.Supplier.SalesByDayHorizontalBySupplier
...
{
  public class SalesByDayHorizontalBySupplier : 
    SalesByDayHorizontalByStore<SalesByDayHorizontalBySupplier>
  {
    ...
    public override string ToString() => string.Format("{0} [{1}:{2}] Count : {3}", (object) nameof (SalesByDayHorizontalBySupplier), (object) this.su_SupplierName, (object) this.sbd_Supplier, (object) this.Lt_Details.Count);
    ...
    public void PutInfo(SalesByDayHorizontalBySupplier pSource)
    {
      this.PutInfo((SalesByDayHorizontalByStore) pSource);
    ...
    public void Add(SalesByDayHorizontalBySupplier item)
    {
    ...
    public void AddRange(IList<SalesByDayHorizontalBySupplier> infos)
    {
      foreach (SalesByDayHorizontalBySupplier info in (IEnumerable<SalesByDayHorizontalBySupplier>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, SalesByDayHorizontalBySupplier pSource) => pSource == null || this.IsZero(pCheckType, (SalesByDayHorizontalByStore) pSource);
    ...
    public async Task<IList<SalesByDayHorizontalBySupplier>> SelectDayHorizontalBySupplierListAsync(
      object p_param)
    {
      SalesByDayHorizontalBySupplier horizontalBySupplier1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(horizontalBySupplier1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<SalesByDayHorizontalBySupplier>) null;
        }
        IList<SalesByDayHorizontalBySupplier> lt_list = (IList<SalesByDayHorizontalBySupplier>) new List<SalesByDayHorizontalBySupplier>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            SalesByDayHorizontalBySupplier horizontalBySupplier2 = horizontalBySupplier1.OleDB.Create<SalesByDayHorizontalBySupplier>();
    ...
    public async IAsyncEnumerable<SalesByDayHorizontalBySupplier> SelectDayHorizontalBySupplierEnumerableAsync(
      object p_param)
    {
      SalesByDayHorizontalBySupplier horizontalBySupplier1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

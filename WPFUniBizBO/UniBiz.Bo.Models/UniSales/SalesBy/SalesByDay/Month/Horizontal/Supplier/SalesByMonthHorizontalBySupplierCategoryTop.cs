...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Month.Horizontal.Supplier.SalesByMonthHorizontalBySupplierCategoryTop
...
{
  public class SalesByMonthHorizontalBySupplierCategoryTop : 
    SalesByMonthHorizontalBySupplier<SalesByMonthHorizontalBySupplierCategoryTop>
  {
    ...
    public override string ToString() => string.Format("{0} [{1}({2})][{3}] Count : {4}", (object) nameof (SalesByMonthHorizontalBySupplierCategoryTop), (object) this.su_SupplierName, (object) this.sbd_Supplier, (object) this.ctg_lv1_Name, (object) this.Lt_Details.Count);
    ...
    public void PutInfo(
      SalesByMonthHorizontalBySupplierCategoryTop pSource)
    {
      this.PutInfo((SalesByMonthHorizontalBySupplier) pSource);
    ...
    public void Add(SalesByMonthHorizontalBySupplierCategoryTop item)
    {
    ...
    public void AddRange(
      IList<SalesByMonthHorizontalBySupplierCategoryTop> infos)
    {
      foreach (SalesByMonthHorizontalBySupplierCategoryTop info in (IEnumerable<SalesByMonthHorizontalBySupplierCategoryTop>) infos)
        this.Add(info);
    }
    ...
    public bool IsZero(
      ...
      SalesByMonthHorizontalBySupplierCategoryTop pSource)
    {
      return pSource == null || this.IsZero(pCheckType, (SalesByMonthHorizontalBySupplier) pSource);
    }
    ...
    public async Task<IList<SalesByMonthHorizontalBySupplierCategoryTop>> SelectMonthHorizontalBySupplierCategoryTopListAsync(
      object p_param)
    {
      SalesByMonthHorizontalBySupplierCategoryTop supplierCategoryTop1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(supplierCategoryTop1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<SalesByMonthHorizontalBySupplierCategoryTop>) null;
        }
        IList<SalesByMonthHorizontalBySupplierCategoryTop> lt_list = (IList<SalesByMonthHorizontalBySupplierCategoryTop>) new List<SalesByMonthHorizontalBySupplierCategoryTop>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            SalesByMonthHorizontalBySupplierCategoryTop supplierCategoryTop2 = supplierCategoryTop1.OleDB.Create<SalesByMonthHorizontalBySupplierCategoryTop>();
    ...
    public async IAsyncEnumerable<SalesByMonthHorizontalBySupplierCategoryTop> SelectMonthHorizontalBySupplierCategoryTopEnumerableAsync(
      object p_param)
    {
      SalesByMonthHorizontalBySupplierCategoryTop supplierCategoryTop1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

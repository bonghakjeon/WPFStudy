...
// Type: UniBiz.Bo.Models.UniStock.Statement.Day.Vertical.StatementDayVerticalByDeptPack
...
{
  public class StatementDayVerticalByDeptPack : BindableBase
  {
    private IList<DeptView> _DataHeader;
    private StatementDayVerticalByDeptDic _DataBody;
    ...
    public StatementDayVerticalByDeptDic DataBody
    {
      get => this._DataBody;
      set
      {

...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Day.Horizontal.Supplier.SalesByDayHorizontalBySupplierGoods
...
{
  public class SalesByDayHorizontalBySupplierGoods : 
    SalesByDayHorizontalBySupplierCategoryBot<SalesByDayHorizontalBySupplierGoods>
  {
    ...
    public override string ToString() => string.Format("{0} [{1}({2})][{3}({4})] Count : {5}", (object) nameof (SalesByDayHorizontalBySupplierGoods), (object) this.su_SupplierName, (object) this.sbd_Supplier, (object) this.gd_GoodsName, (object) this.gd_BarCode, (object) this.Lt_Details.Count);
    ...
    public void PutInfo(SalesByDayHorizontalBySupplierGoods pSource)
    {
      this.PutInfo((SalesByDayHorizontalBySupplierCategoryBot) pSource);
    ...
    public void Add(SalesByDayHorizontalBySupplierGoods item)
    {
    ...
    public void AddRange(IList<SalesByDayHorizontalBySupplierGoods> infos)
    {
      foreach (SalesByDayHorizontalBySupplierGoods info in (IEnumerable<SalesByDayHorizontalBySupplierGoods>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, SalesByDayHorizontalBySupplierGoods pSource) => pSource == null || this.IsZero(pCheckType, (SalesByDayHorizontalBySupplierCategoryBot) pSource);
    ...
    public async Task<IList<SalesByDayHorizontalBySupplierGoods>> SelectDayHorizontalBySupplierGoodsListAsync(
      object p_param)
    {
      SalesByDayHorizontalBySupplierGoods horizontalBySupplierGoods1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(horizontalBySupplierGoods1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<SalesByDayHorizontalBySupplierGoods>) null;
        }
        IList<SalesByDayHorizontalBySupplierGoods> lt_list = (IList<SalesByDayHorizontalBySupplierGoods>) new List<SalesByDayHorizontalBySupplierGoods>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            SalesByDayHorizontalBySupplierGoods horizontalBySupplierGoods2 = horizontalBySupplierGoods1.OleDB.Create<SalesByDayHorizontalBySupplierGoods>();
    ...
    public async IAsyncEnumerable<SalesByDayHorizontalBySupplierGoods> SelectDayHorizontalBySupplierGoodsEnumerableAsync(
      object p_param)
    {
      SalesByDayHorizontalBySupplierGoods horizontalBySupplierGoods1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

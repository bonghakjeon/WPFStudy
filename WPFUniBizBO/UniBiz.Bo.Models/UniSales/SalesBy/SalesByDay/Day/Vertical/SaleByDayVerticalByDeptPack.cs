...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Day.Vertical.SaleByDayVerticalByDeptPack
...
{
  public class SaleByDayVerticalByDeptPack : BindableBase
  {
    private IList<DeptView> _DataHeader;
    private SaleByDayVerticalByDeptDic _DataBody;
    ...
    public SaleByDayVerticalByDeptDic DataBody
    {
      get => this._DataBody;
      set
      {

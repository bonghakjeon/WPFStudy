...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Month.Horizontal.Supplier.SalesByMonthHorizontalBySupplierPack
...
{
  public class SalesByMonthHorizontalBySupplierPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private SalesByMonthHorizontalBySupplierDic _DataBody;
    ...
    public SalesByMonthHorizontalBySupplierDic DataBody
    {
      get => this._DataBody;
      set
      {

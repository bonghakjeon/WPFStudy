...
// Type: UniBiz.Bo.Models.UniStock.Statement.Day.Horizontal.StatementDayHorizontalByDeptPack
...
{
  public class StatementDayHorizontalByDeptPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private StatementDayHorizontalByDeptDic _DataBody;
    ...
    public StatementDayHorizontalByDeptDic DataBody
    {
      get => this._DataBody;
      set
      {

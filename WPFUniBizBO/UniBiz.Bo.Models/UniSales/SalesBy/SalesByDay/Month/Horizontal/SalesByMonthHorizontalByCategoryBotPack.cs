...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Month.Horizontal.SalesByMonthHorizontalByCategoryBotPack
...
{
  public class SalesByMonthHorizontalByCategoryBotPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private SalesByMonthHorizontalByCategoryBotDic _DataBody;
    ...
    public SalesByMonthHorizontalByCategoryBotDic DataBody
    {
      get => this._DataBody;
      set
      {

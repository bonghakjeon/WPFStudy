...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Month.Horizontal.SalesByMonthHorizontalByCategoryMid
...
{
  public class SalesByMonthHorizontalByCategoryMid : 
    SalesByMonthHorizontalByCategoryTop<SalesByMonthHorizontalByCategoryMid>
  {
    ...
    public void PutInfo(SalesByMonthHorizontalByCategoryMid pSource)
    {
      this.PutInfo((SalesByMonthHorizontalByCategoryTop) pSource);
    ...
    public void Add(SalesByMonthHorizontalByCategoryMid item)
    {
    ...
    public void AddRange(IList<SalesByMonthHorizontalByCategoryMid> infos)
    {
      foreach (SalesByMonthHorizontalByCategoryMid info in (IEnumerable<SalesByMonthHorizontalByCategoryMid>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, SalesByMonthHorizontalByCategoryMid pSource) => pSource == null || this.IsZero(pCheckType, (SalesByMonthHorizontalByCategoryTop) pSource);
    ...
    public async Task<IList<SalesByMonthHorizontalByCategoryMid>> SelectMonthHorizontalByCategoryMidListAsync(
      object p_param)
    {
      SalesByMonthHorizontalByCategoryMid horizontalByCategoryMid1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(horizontalByCategoryMid1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<SalesByMonthHorizontalByCategoryMid>) null;
        }
        IList<SalesByMonthHorizontalByCategoryMid> lt_list = (IList<SalesByMonthHorizontalByCategoryMid>) new List<SalesByMonthHorizontalByCategoryMid>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            SalesByMonthHorizontalByCategoryMid horizontalByCategoryMid2 = horizontalByCategoryMid1.OleDB.Create<SalesByMonthHorizontalByCategoryMid>();
    ...
    public async IAsyncEnumerable<SalesByMonthHorizontalByCategoryMid> SelectMonthHorizontalByCategoryMidEnumerableAsync(
      object p_param)
    {
      SalesByMonthHorizontalByCategoryMid horizontalByCategoryMid1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

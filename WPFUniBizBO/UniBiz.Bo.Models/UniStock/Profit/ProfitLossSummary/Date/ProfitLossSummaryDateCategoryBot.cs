...
// Type: UniBiz.Bo.Models.UniStock.Profit.ProfitLossSummary.Date.ProfitLossSummaryDateCategoryBot
...
{
  public class ProfitLossSummaryDateCategoryBot : 
    ProfitLossSummaryDateCategoryMid<ProfitLossSummaryDateCategoryBot>
  {
    ...
    protected override UbModelBase CreateClone => (UbModelBase) new ProfitLossSummaryDateCategoryBot();

    public override object Clone()
    {
      ProfitLossSummaryDateCategoryBot summaryDateCategoryBot = base.Clone() as ProfitLossSummaryDateCategoryBot;
    ...
    public void PutData(ProfitLossSummaryDateCategoryBot pSource)
    {
      this.PutData((ProfitLossSummaryDateCategoryMid) pSource);
      this.ctg_ViewCode = pSource.ctg_ViewCode;
      this.ctg_CategoryName = pSource.ctg_CategoryName;
    }

    public bool IsZero(EnumZeroCheck pCheckType, ProfitLossSummaryDateCategoryBot pSource) => pSource == null || this.IsZero(pCheckType, (ProfitLossSummaryDateCategoryMid) pSource);
    ...
    public async Task<IList<ProfitLossSummaryDateCategoryBot>> SelectDateCategoryBotListAsync(
      object p_param)
    {
      ProfitLossSummaryDateCategoryBot summaryDateCategoryBot1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(summaryDateCategoryBot1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<ProfitLossSummaryDateCategoryBot>) null;
        }
        IList<ProfitLossSummaryDateCategoryBot> lt_list = (IList<ProfitLossSummaryDateCategoryBot>) new List<ProfitLossSummaryDateCategoryBot>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            ProfitLossSummaryDateCategoryBot summaryDateCategoryBot2 = summaryDateCategoryBot1.OleDB.Create<ProfitLossSummaryDateCategoryBot>();
    ...
    public async IAsyncEnumerable<ProfitLossSummaryDateCategoryBot> SelectDateCategoryBotEnumerableAsync(
      object p_param)
    {
      ProfitLossSummaryDateCategoryBot summaryDateCategoryBot1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

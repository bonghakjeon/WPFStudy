...
// Type: UniBiz.Bo.Models.UniStock.Statement.Day.Horizontal.Supplier.StatementDayHorizontalBySupplierCatMidPack
...
{
  public class StatementDayHorizontalBySupplierCatMidPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private StatementDayHorizontalBySupplierCatMidDic _DataBody;
    ...
    public StatementDayHorizontalBySupplierCatMidDic DataBody
    {
      get => this._DataBody;
      set
      {

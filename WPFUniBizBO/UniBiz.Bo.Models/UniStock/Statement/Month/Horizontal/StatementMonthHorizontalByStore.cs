...
// Type: UniBiz.Bo.Models.UniStock.Statement.Month.Horizontal.StatementMonthHorizontalByStore
...
{
  public class StatementMonthHorizontalByStore : 
    StatementMonthHorizontal<StatementMonthHorizontalByStore>
  {
    ...
    public override string KeyCode => string.Format("{0}", (object) this.sh_StoreCode);

    public override int sh_StoreCode
    {
    ...
    public override string ToString() => string.Format("{0} [{1}:{2}] Count : {3}", (object) nameof (StatementMonthHorizontalByStore), (object) this.si_StoreName, (object) this.sh_StoreCode, (object) this.Lt_Details.Count);
    ...
    public void PutInfo(StatementMonthHorizontalByStore pSource)
    {
    ...
    public void InitInfo(StatementMonthHorizontalByStore pData, IList<DateTime> p_Days)
    {
      if (!this.KeyCode.Equals(pData.KeyCode))
        throw new Exception("pData 의 [sh_StoreCode] 이 KeyCode 와 다릅니다");
      this.PutInfo(pData);
    ...
    public void Add(StatementMonthHorizontalByStore item)
    {
      ...
      else
      {
        ...
        if (!this.KeyCode.Equals(item.KeyCode))
          throw new Exception("item 의 sh_StoreCode 이 sh_StoreCode 와 다릅니다");
      }
      this.CalcAddSum((StatementMonthHorizontal) item);
      StatementMonthHorizontal statementMonthHorizontal = this.Lt_Details.FirstOrDefault<StatementMonthHorizontal>((Func<StatementMonthHorizontal, bool>) (it => it.sh_ConfirmDate.Value.Equals(item.sh_ConfirmDate.Value)));
    ...
    public void AddRange(IList<StatementMonthHorizontalByStore> infos)
    {
      foreach (StatementMonthHorizontalByStore info in (IEnumerable<StatementMonthHorizontalByStore>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, StatementMonthHorizontalByStore pSource) => pSource == null || this.IsZero(pCheckType, (StatementMonthHorizontal) pSource);
    ...
    public async Task<IList<StatementMonthHorizontalByStore>> SelectMonthHorizontalByStoreListAsync(
      object p_param)
    {
      StatementMonthHorizontalByStore horizontalByStore1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(horizontalByStore1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<StatementMonthHorizontalByStore>) null;
        }
        IList<StatementMonthHorizontalByStore> lt_list = (IList<StatementMonthHorizontalByStore>) new List<StatementMonthHorizontalByStore>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            StatementMonthHorizontalByStore horizontalByStore2 = horizontalByStore1.OleDB.Create<StatementMonthHorizontalByStore>();
    ...
    public async IAsyncEnumerable<StatementMonthHorizontalByStore> SelectMonthHorizontalByStoreEnumerableAsync(
      object p_param)
    {
      StatementMonthHorizontalByStore horizontalByStore1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;
    ...
    public override string GetSelectQuery(object p_param)
    {
      ...
      try
      {
        ...
        stringBuilder.Append("," + (p_isStoreTotal ? " 1 AS" : string.Empty) + " sh_StoreCode");

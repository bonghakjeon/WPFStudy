...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Month.Horizontal.SalesByMonthHorizontalByStore
...
{
  public class SalesByMonthHorizontalByStore : SalesByMonthGoal<SalesByMonthHorizontalByStore>
  {
    ...
    public override string ToString() => string.Format("{0} [{1}:{2}] Count : {3}", (object) nameof (SalesByMonthHorizontalByStore), (object) this.si_StoreName, (object) this.si_StoreCode, (object) this.Lt_Details.Count);
    ...
    public void PutInfo(SalesByMonthHorizontalByStore pSource)
    {
    ...
    public void Add(SalesByMonthHorizontalByStore item)
    {
      ...
      SalesByDayGoal salesByDayGoal = this.Lt_Details.Where<SalesByDayGoal>((Func<SalesByDayGoal, bool>) (it => it.sbd_SaleDate.Equals((object) item.sbd_SaleDate))).FirstOrDefault<SalesByDayGoal>();
    ...
    public void AddRange(IList<SalesByMonthHorizontalByStore> infos)
    {
      foreach (SalesByMonthHorizontalByStore info in (IEnumerable<SalesByMonthHorizontalByStore>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, SalesByMonthHorizontalByStore pSource) => pSource == null || this.IsZero(pCheckType, (SalesByMonthGoal) pSource);
    ...
    public async Task<IList<SalesByMonthHorizontalByStore>> SelectMonthHorizontalByStoreListAsync(
      object p_param)
    {
      SalesByMonthHorizontalByStore horizontalByStore1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(horizontalByStore1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<SalesByMonthHorizontalByStore>) null;
        }
        IList<SalesByMonthHorizontalByStore> lt_list = (IList<SalesByMonthHorizontalByStore>) new List<SalesByMonthHorizontalByStore>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            SalesByMonthHorizontalByStore horizontalByStore2 = horizontalByStore1.OleDB.Create<SalesByMonthHorizontalByStore>();
    ...
    public async IAsyncEnumerable<SalesByMonthHorizontalByStore> SelectMonthHorizontalByStoreEnumerableAsync(
      object p_param)
    {
      SalesByMonthHorizontalByStore horizontalByStore1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;
    ...
    public override string GetSelectQuery(object p_param)
    {
      ...
      try
      {
        ...
        if (p_param is Hashtable hashtable)
        {
          ...
          if (hashtable.ContainsKey((object) "sbd_StoreCode_IS_TOTAL_SUM_") && Convert.ToBoolean(hashtable[(object) "sbd_StoreCode_IS_TOTAL_SUM_"].ToString()))
            p_isStoreTotal = Convert.ToBoolean(hashtable[(object) "sbd_StoreCode_IS_TOTAL_SUM_"].ToString());

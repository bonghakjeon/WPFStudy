...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Month.Vertical.SaleByMonthVerticalByCategoryTopPack
...
{
  public class SaleByMonthVerticalByCategoryTopPack : BindableBase
  {
    private IList<CategoryView> _DataHeader;
    private SaleByMonthVerticalByCategoryTopDic _DataBody;
    ...
    public SaleByMonthVerticalByCategoryTopDic DataBody
    {
      get => this._DataBody;
      set
      {

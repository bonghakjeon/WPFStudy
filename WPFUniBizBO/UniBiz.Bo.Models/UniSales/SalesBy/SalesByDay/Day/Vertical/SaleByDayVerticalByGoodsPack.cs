...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Day.Vertical.SaleByDayVerticalByGoodsPack
...
{
  public class SaleByDayVerticalByGoodsPack : BindableBase
  {
    private IList<TGoods> _DataHeader;
    private SaleByDayVerticalByGoodsDic _DataBody;
    ...
    public SaleByDayVerticalByGoodsDic DataBody
    {
      get => this._DataBody;
      set
      {

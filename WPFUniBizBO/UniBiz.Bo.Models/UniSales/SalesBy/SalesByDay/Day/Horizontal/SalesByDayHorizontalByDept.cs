...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Day.Horizontal.SalesByDayHorizontalByDept
...
{
  public class SalesByDayHorizontalByDept : SalesByDayHorizontalByTeam<SalesByDayHorizontalByDept>
  {
    ...
    public void PutInfo(SalesByDayHorizontalByDept pSource)
    {
      this.PutInfo((SalesByDayHorizontalByTeam) pSource);
    ...
    public void Add(SalesByDayHorizontalByDept item)
    {
    ...
    public void AddRange(IList<SalesByDayHorizontalByDept> infos)
    {
      foreach (SalesByDayHorizontalByDept info in (IEnumerable<SalesByDayHorizontalByDept>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, SalesByDayHorizontalByDept pSource) => pSource == null || this.IsZero(pCheckType, (SalesByDayHorizontalByTeam) pSource);
    ...
    public async Task<IList<SalesByDayHorizontalByDept>> SelectDayHorizontalByDeptListAsync(
      object p_param)
    {
      SalesByDayHorizontalByDept horizontalByDept1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(horizontalByDept1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<SalesByDayHorizontalByDept>) null;
        }
        IList<SalesByDayHorizontalByDept> lt_list = (IList<SalesByDayHorizontalByDept>) new List<SalesByDayHorizontalByDept>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            SalesByDayHorizontalByDept horizontalByDept2 = horizontalByDept1.OleDB.Create<SalesByDayHorizontalByDept>();
    ...
    public async IAsyncEnumerable<SalesByDayHorizontalByDept> SelectDayHorizontalByDeptEnumerableAsync(
      object p_param)
    {
      SalesByDayHorizontalByDept horizontalByDept1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

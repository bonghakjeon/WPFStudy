...
// Type: UniBiz.Bo.Models.UniStock.Statement.Day.Horizontal.StatementDayHorizontalByCategoryBot
...
{
  public class StatementDayHorizontalByCategoryBot : 
    StatementDayHorizontalByCategoryMid<StatementDayHorizontalByCategoryBot>
  {
    ...
    public override string ToString() => string.Format("{0} [{1}:{2}>{3}>{4}] Count : {5}", (object) nameof (StatementDayHorizontalByCategoryBot), (object) this.si_StoreName, (object) this.ctg_lv1_Name, (object) this.ctg_lv2_Name, (object) this.ctg_lv3_Name, (object) this.Lt_Details.Count);
    ...
    public void PutInfo(StatementDayHorizontalByCategoryBot pSource)
    {
      this.PutInfo((StatementDayHorizontalByCategoryMid) pSource);
    ...
    public void Add(StatementDayHorizontalByCategoryBot item)
    {
    ...
    public void AddRange(IList<StatementDayHorizontalByCategoryBot> infos)
    {
      foreach (StatementDayHorizontalByCategoryBot info in (IEnumerable<StatementDayHorizontalByCategoryBot>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, StatementDayHorizontalByCategoryBot pSource) => pSource == null || this.IsZero(pCheckType, (StatementDayHorizontalByCategoryMid) pSource);
    ...
    public async Task<IList<StatementDayHorizontalByCategoryBot>> SelectDayHorizontalByCategoryBotListAsync(
      object p_param)
    {
      StatementDayHorizontalByCategoryBot horizontalByCategoryBot1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(horizontalByCategoryBot1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<StatementDayHorizontalByCategoryBot>) null;
        }
        IList<StatementDayHorizontalByCategoryBot> lt_list = (IList<StatementDayHorizontalByCategoryBot>) new List<StatementDayHorizontalByCategoryBot>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            StatementDayHorizontalByCategoryBot horizontalByCategoryBot2 = horizontalByCategoryBot1.OleDB.Create<StatementDayHorizontalByCategoryBot>();
    ...
    public async IAsyncEnumerable<StatementDayHorizontalByCategoryBot> SelectDayHorizontalByCategoryBotEnumerableAsync(
      object p_param)
    {
      StatementDayHorizontalByCategoryBot horizontalByCategoryBot1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

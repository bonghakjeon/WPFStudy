...
// Type: UniBiz.Bo.Models.UniStock.Statement.Day.Vertical.StatementDayVerticalByCategoryTop
...
{
  public class StatementDayVerticalByCategoryTop : 
    StatementDayVerticalByDept<StatementDayVerticalByCategoryTop>
  {
    ...
    public override string ToString() => string.Format("{0} [{1}] Count : {2}", (object) nameof (StatementDayVerticalByCategoryTop), (object) this.sh_ConfirmDate, (object) this.Lt_Details.Count);
    ...
    public void Add(StatementDayVerticalByCategoryTop item)
    {
    ...
    public void AddRange(IList<StatementDayVerticalByCategoryTop> infos)
    {
      foreach (StatementDayVerticalByCategoryTop info in (IEnumerable<StatementDayVerticalByCategoryTop>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, StatementDayVerticalByCategoryTop pSource) => pSource == null || this.IsZero(pCheckType, (StatementDayVerticalByDept) pSource);
    ...
    public async Task<IList<StatementDayVerticalByCategoryTop>> SelectDayVerticalByCategoryTopListAsync(
      object p_param)
    {
      StatementDayVerticalByCategoryTop verticalByCategoryTop1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(verticalByCategoryTop1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<StatementDayVerticalByCategoryTop>) null;
        }
        IList<StatementDayVerticalByCategoryTop> lt_list = (IList<StatementDayVerticalByCategoryTop>) new List<StatementDayVerticalByCategoryTop>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            StatementDayVerticalByCategoryTop verticalByCategoryTop2 = verticalByCategoryTop1.OleDB.Create<StatementDayVerticalByCategoryTop>();
    ...
    public async IAsyncEnumerable<StatementDayVerticalByCategoryTop> SelectDayVerticalByCategoryTopEnumerableAsync(
      object p_param)
    {
      StatementDayVerticalByCategoryTop verticalByCategoryTop1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;
    ...
    public override string GetSelectQuery(object p_param) => new StatementDayHorizontalByCategoryTop().GetSelectQuery(p_param);
  }
}

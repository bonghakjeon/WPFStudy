...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Day.Vertical.SaleByDayVerticalByCategoryBot
...
{
  public class SaleByDayVerticalByCategoryBot : 
    SaleByDayVerticalByCategoryMid<SaleByDayVerticalByCategoryBot>
  {
    ...
    public override string ToString() => string.Format("{0} [{1}] Count : {2}", (object) nameof (SaleByDayVerticalByCategoryBot), (object) this.sbd_SaleDate, (object) this.Lt_Details.Count);
    ...
    public void Add(SaleByDayVerticalByCategoryBot item)
    {
    ...
    public void AddRange(IList<SaleByDayVerticalByCategoryBot> infos)
    {
      foreach (SaleByDayVerticalByCategoryBot info in (IEnumerable<SaleByDayVerticalByCategoryBot>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, SaleByDayVerticalByCategoryBot pSource) => pSource == null || this.IsZero(pCheckType, (SaleByDayVerticalByCategoryMid) pSource);
    ...
    public async Task<IList<SaleByDayVerticalByCategoryBot>> SelectDayVerticalByCategoryBotListAsync(
      object p_param)
    {
      SaleByDayVerticalByCategoryBot verticalByCategoryBot1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(verticalByCategoryBot1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<SaleByDayVerticalByCategoryBot>) null;
        }
        IList<SaleByDayVerticalByCategoryBot> lt_list = (IList<SaleByDayVerticalByCategoryBot>) new List<SaleByDayVerticalByCategoryBot>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            SaleByDayVerticalByCategoryBot verticalByCategoryBot2 = verticalByCategoryBot1.OleDB.Create<SaleByDayVerticalByCategoryBot>();
    ...
    public async IAsyncEnumerable<SaleByDayVerticalByCategoryBot> SelectDayVerticalByCategoryBotEnumerableAsync(
      object p_param)
    {
      SaleByDayVerticalByCategoryBot verticalByCategoryBot1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;
    ...
    public override string GetSelectQuery(object p_param) => new SalesByDayHorizontalByCategoryBot().GetSelectQuery(p_param);
  }
}

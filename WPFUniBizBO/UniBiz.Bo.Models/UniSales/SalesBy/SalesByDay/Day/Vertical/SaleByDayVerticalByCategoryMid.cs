...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Day.Vertical.SaleByDayVerticalByCategoryMid
...
{
  public class SaleByDayVerticalByCategoryMid : 
    SaleByDayVerticalByCategoryTop<SaleByDayVerticalByCategoryMid>
  {
    ...
    public override string ToString() => string.Format("{0} [{1}] Count : {2}", (object) nameof (SaleByDayVerticalByCategoryMid), (object) this.sbd_SaleDate, (object) this.Lt_Details.Count);
    ...
    public void Add(SaleByDayVerticalByCategoryMid item)
    {
    ...
    public void AddRange(IList<SaleByDayVerticalByCategoryMid> infos)
    {
      foreach (SaleByDayVerticalByCategoryMid info in (IEnumerable<SaleByDayVerticalByCategoryMid>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, SaleByDayVerticalByCategoryMid pSource) => pSource == null || this.IsZero(pCheckType, (SaleByDayVerticalByCategoryTop) pSource);
    ...
    public async Task<IList<SaleByDayVerticalByCategoryMid>> SelectDayVerticalByCategoryMidListAsync(
      object p_param)
    {
      SaleByDayVerticalByCategoryMid verticalByCategoryMid1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(verticalByCategoryMid1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<SaleByDayVerticalByCategoryMid>) null;
        }
        IList<SaleByDayVerticalByCategoryMid> lt_list = (IList<SaleByDayVerticalByCategoryMid>) new List<SaleByDayVerticalByCategoryMid>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            SaleByDayVerticalByCategoryMid verticalByCategoryMid2 = verticalByCategoryMid1.OleDB.Create<SaleByDayVerticalByCategoryMid>();
    ...
    public async IAsyncEnumerable<SaleByDayVerticalByCategoryMid> SelectDayVerticalByCategoryMidEnumerableAsync(
      object p_param)
    {
      SaleByDayVerticalByCategoryMid verticalByCategoryMid1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;
    ...
    public override string GetSelectQuery(object p_param) => new SalesByDayHorizontalByCategoryMid().GetSelectQuery(p_param);
  }
}

...
// Type: UniBiz.Bo.Models.UniStock.Statement.Month.Vertical.StatementMonthVerticalByCategoryTopPack
...
{
  public class StatementMonthVerticalByCategoryTopPack : BindableBase
  {
    private IList<CategoryView> _DataHeader;
    private StatementMonthVerticalByCategoryTopDic _DataBody;
    ...
    public StatementMonthVerticalByCategoryTopDic DataBody
    {
      get => this._DataBody;
      set
      {

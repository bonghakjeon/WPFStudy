...
// Type: UniBiz.Bo.Models.UniStock.Statement.Day.Horizontal.StatementDayHorizontalByCategoryBotPack
...
{
  public class StatementDayHorizontalByCategoryBotPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private StatementDayHorizontalByCategoryBotDic _DataBody;
    ...
    public StatementDayHorizontalByCategoryBotDic DataBody
    {
      get => this._DataBody;
      set
      {

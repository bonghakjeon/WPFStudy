...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Day.Horizontal.SalesByDayHorizontalByDeptPack
...
{
  public class SalesByDayHorizontalByDeptPack : BindableBase
  {
    private IList<DateTime> _DataHeader;
    private SalesByDayHorizontalByDeptDic _DataBody;
    ...
    public SalesByDayHorizontalByDeptDic DataBody
    {
      get => this._DataBody;
      set
      {

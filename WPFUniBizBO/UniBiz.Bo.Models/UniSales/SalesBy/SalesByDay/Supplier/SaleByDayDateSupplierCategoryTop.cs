...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Supplier.SaleByDayDateSupplierCategoryTop
...
{
  public class SaleByDayDateSupplierCategoryTop : 
    SaleByDayDateSupplier<SaleByDayDateSupplierCategoryTop>
  {
    ...
    protected override UbModelBase CreateClone => (UbModelBase) new SaleByDayDateSupplierCategoryTop();

    public override object Clone()
    {
      SaleByDayDateSupplierCategoryTop supplierCategoryTop = base.Clone() as SaleByDayDateSupplierCategoryTop;
      supplierCategoryTop.ctg_lv1_ID = this.ctg_lv1_ID;
      supplierCategoryTop.ctg_lv1_ViewCode = this.ctg_lv1_ViewCode;
      supplierCategoryTop.ctg_lv1_Name = this.ctg_lv1_Name;
      return (object) supplierCategoryTop;
    }

    public void PutData(SaleByDayDateSupplierCategoryTop pSource)
    {
    ...
    public bool IsZero(EnumZeroCheck pCheckType, SaleByDayDateSupplierCategoryTop pSource) => pSource == null || this.IsZero(pCheckType, (SaleByDayDateSupplier) pSource);
    ...
    public async Task<IList<SaleByDayDateSupplierCategoryTop>> SelectDateSupplierCategoryTopListAsync(
      object p_param)
    {
      SaleByDayDateSupplierCategoryTop supplierCategoryTop1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(supplierCategoryTop1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<SaleByDayDateSupplierCategoryTop>) null;
        }
        IList<SaleByDayDateSupplierCategoryTop> lt_list = (IList<SaleByDayDateSupplierCategoryTop>) new List<SaleByDayDateSupplierCategoryTop>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            SaleByDayDateSupplierCategoryTop supplierCategoryTop2 = supplierCategoryTop1.OleDB.Create<SaleByDayDateSupplierCategoryTop>();
    ...
    public async IAsyncEnumerable<SaleByDayDateSupplierCategoryTop> SelectDateSupplierCategoryTopEnumerableAsync(
      object p_param)
    {
      SaleByDayDateSupplierCategoryTop supplierCategoryTop1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

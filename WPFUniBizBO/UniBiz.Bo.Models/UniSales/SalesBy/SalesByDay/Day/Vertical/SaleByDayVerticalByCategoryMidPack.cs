...
// Type: UniBiz.Bo.Models.UniSales.SalesBy.SalesByDay.Day.Vertical.SaleByDayVerticalByCategoryMidPack
...
{
  public class SaleByDayVerticalByCategoryMidPack : BindableBase
  {
    private IList<CategoryView> _DataHeader;
    private SaleByDayVerticalByCategoryMidDic _DataBody;
    ...
    public SaleByDayVerticalByCategoryMidDic DataBody
    {
      get => this._DataBody;
      set
      {

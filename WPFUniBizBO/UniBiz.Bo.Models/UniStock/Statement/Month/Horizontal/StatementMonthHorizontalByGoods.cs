...
// Type: UniBiz.Bo.Models.UniStock.Statement.Month.Horizontal.StatementMonthHorizontalByGoods
...
{
  public class StatementMonthHorizontalByGoods : 
    StatementMonthHorizontalByCategoryBot<StatementMonthHorizontalByGoods>
  {
    ...
    public override string ToString() => string.Format("{0} [{1}:{2}({3})] Count : {4}", (object) nameof (StatementMonthHorizontalByGoods), (object) this.si_StoreName, (object) this.gd_GoodsName, (object) this.gd_BarCode, (object) this.Lt_Details.Count);
    ...
    public void PutInfo(StatementMonthHorizontalByGoods pSource)
    {
      this.PutInfo((StatementMonthHorizontalByCategoryBot) pSource);
    ...
    public void Add(StatementMonthHorizontalByGoods item)
    {
    ...
    public void AddRange(IList<StatementMonthHorizontalByGoods> infos)
    {
      foreach (StatementMonthHorizontalByGoods info in (IEnumerable<StatementMonthHorizontalByGoods>) infos)
        this.Add(info);
    }

    public bool IsZero(EnumZeroCheck pCheckType, StatementMonthHorizontalByGoods pSource) => pSource == null || this.IsZero(pCheckType, (StatementMonthHorizontalByCategoryBot) pSource);
    ...
    public async Task<IList<StatementMonthHorizontalByGoods>> SelectMonthHorizontalByGoodsListAsync(
      object p_param)
    {
      StatementMonthHorizontalByGoods horizontalByGoods1 = this;
      ...
      try
      {
        ...
        if (!await rs.OpenAsync(horizontalByGoods1.GetSelectQuery(p_param)))
        {
          ...
          return (IList<StatementMonthHorizontalByGoods>) null;
        }
        IList<StatementMonthHorizontalByGoods> lt_list = (IList<StatementMonthHorizontalByGoods>) new List<StatementMonthHorizontalByGoods>();
        if (await rs.IsDataReadAsync())
        {
          do
          {
            StatementMonthHorizontalByGoods horizontalByGoods2 = horizontalByGoods1.OleDB.Create<StatementMonthHorizontalByGoods>();
    ...
    public async IAsyncEnumerable<StatementMonthHorizontalByGoods> SelectMonthHorizontalByGoodsEnumerableAsync(
      object p_param)
    {
      StatementMonthHorizontalByGoods horizontalByGoods1 = this;
      UniOleDbRecordset rs = (UniOleDbRecordset) null;

...
// Type: UniBiz.Bo.Models.JobEvtMessage.JobEvtPaymentMonthWork
...
{
  public class JobEvtPaymentMonthWork : JobEvtBase
  {
    private int _si_StoreCode;
    private string _si_StoreCodeIn;
    private PaymentMonthWorkPack _WorkInfo;
    ...
    [JsonIgnore]
    public PaymentMonthWorkPack WorkInfo
    {
      get => this._WorkInfo;
      set
      {
    ...
    public JobEvtPaymentMonthWork() => this.resource = 11;
  }
}
